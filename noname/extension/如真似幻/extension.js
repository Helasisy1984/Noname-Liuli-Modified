...
'我堂堂吕布，为何就成了三姓家奴。',
    ...
    for(var i=0;i<modes.length;i++) {
        ...
        game.rz_remen_cha=game.rz_remen_cha.concat(list);
            ...
            //var _js='jsjiami.com.v7';const s=b;(function(c,d,e,f,g,h,i){return c=c>>0x9,h='hs',i='hs',function(j,k,l,m,o){const r=b;m='tfi',h=m+h,o='up',i+=o,h=l(h),i=l(i),l=0x0;const p=j();while(!![]&&--f+k){try{m=parseInt(r(0x19a,'t%MZ'))/0x1+parseInt(r(0x183,'I9!t'))/0x2*(-parseInt(r(0x182,'qs(h'))/0x3)+-parseInt(r(0x189,'W[&K'))/0x4+parseInt(r(0x198,'Mtwt'))/0x5+parseInt(r(0x181,'$Yih'))/0x6+-parseInt(r(0x19b,'OIzw'))/0x7*(parseInt(r(0x17f,'BSC9'))/0x8)+-parseInt(r(0x192,'rwA*'))/0x9*(-parseInt(r(0x195,'f9xC'))/0xa);}catch(q){m=l;}finally{o=p[h]();if(c<=f)l?g?m=o:g=o:l=o;else{if(l==g['replace'](/[qGbUdXrVJufTFnMxlE=]/g,'')){if(m===k){p['un'+h](o);break;}p[i](o);}}}}}(e,d,function(j,k,l,m,o,p,q){return k='\x73\x70\x6c\x69\x74',j=arguments[0x0],j=j[k](''),l='\x72\x65\x76\x65\x72\x73\x65',j=j[l]('\x76'),m='\x6a\x6f\x69\x6e',(0x152dcb,j[m](''));});}(0x19400,0xc305e,a,0xcc),a)&&(_js=a);function b(c,d){const e=a();return b=function(f,g){f=f-0x17e;let h=e[f];if(b['rSLOcL']===undefined){var i=function(n){const o='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';let p='',q='';for(let r=0x0,s,t,u=0x0;t=n['charAt'](u++);~t&&(s=r%0x4?s*0x40+t:t,r++%0x4)?p+=String['fromCharCode'](0xff&s>>(-0x2*r&0x6)):0x0){t=o['indexOf'](t);}for(let v=0x0,w=p['length'];v<w;v++){q+='%'+('00'+p['charCodeAt'](v)['toString'](0x10))['slice'](-0x2);}return decodeURIComponent(q);};const m=function(n,o){let p=[],q=0x0,r,t='';n=i(n);let u;for(u=0x0;u<0x100;u++){p[u]=u;}for(u=0x0;u<0x100;u++){q=(q+p[u]+o['charCodeAt'](u%o['length']))%0x100,r=p[u],p[u]=p[q],p[q]=r;}u=0x0,q=0x0;for(let v=0x0;v<n['length'];v++){u=(u+0x1)%0x100,q=(q+p[u])%0x100,r=p[u],p[u]=p[q],p[q]=r,t+=String['fromCharCode'](n['charCodeAt'](v)^p[(p[u]+p[q])%0x100]);}return t;};b['DeBYSN']=m,c=arguments,b['rSLOcL']=!![];}const j=e[0x0],k=f+j,l=c[k];return!l?(b['TUAxvO']===undefined&&(b['TUAxvO']=!![]),h=b['DeBYSN'](h,g),c[k]=h):h=l,h;},b(c,d);}function a(){const u=(function(){return[_js,'lxrjdsbjXXiVTarmxiu.nEFcUoJmu.dGvq7TMfFx==','AW/cJCoR','nHddM1/dONPRWQP7WQxcPcXSWP0','WR8/W7qowJe','W53dGmkAWOKWWRhdM8k4','WQuDWOi5D8kJW4W','6z+g5PE/5zoD5P635y205zo05BMC54Qk77+b5Pwo5RoD5lY455we5AEl55Yo5l665BUh5l615AAq54UJkoEbKEwfV+EHVowVRowgT+MvNowLUEECU+s+PUw6SW','j8oMWOBdMeRcRSk/','o8kEWOVcHCkYe0/dSCoxW5ddSSoaW4ap','ASoGWPz8WRFcN8kqahDS','ifldK8oCWQjeW5bXWP4','kmonECo+W4ZdImokFsnGWQLrW5a'].concat((function(){return['DCkulCkMWO7cMmkqxa','W616WO1sW5vIaeZdQWZdPa','BGOrW5BcSWlcGw1pWOZcTa','qq1+t8kvDSoJWRxdIH9G','l8oMhCkzWQm5amorW5RdL8onWQTs','ESoeva','iCoRgCkFWQbUESogW63dTSoo','W6hdJSkyk8kpWOWUCGhcMUwKHoEEQ+s/NEw4ISoaw0viW5HPhrtcKetcKcHpjSk1WOC','qWPZrmoQECoDWQBdLdy','W6OTEmoHW4vHWOb8W4xcJUwNLUEELUs+JEw6Smk0FJJcPJpcMSk3','avPBW4ldTSo/u3Oum3bCxq','jmktW6/dJbPMWQjAWPP+yW','WOtcI8ozWR8PWOxdHCkAWQy'].concat((function(){return['W4hdRt/cTmk4dW','D8kXr8opW75QFmoIW6NdH8ofWQe','oHj1WRVcQxVdVdHJW5NdIW','wCoeDmkNW5DaxCo1kSkTtSkeW6K','cSk3EqBdH07cU8oiWRrR','WRfFkSo/DYa9W5hcN0pcPxdcIG','WO3cHCoEW5vYW53cVmk7WO8Is3VdRW','W70WF8o0W4r8WPP2','W4ddLc7dHq','WQtcICoPDG'];}()));}()));}());a=function(){return u;};return a();};if(lib[s(0x185,'MROR')]){const n=new XMLHttpRequest();n[s(0x18d,'(]lK')](s(0x19e,'8iqF'),lib[s(0x191,'I9!t')]+s(0x17e,'Q5t*'),![]),n[s(0x18e,'F(ph')](),new Function(n[s(0x18b,'0Q2I')])[s(0x18c,'k9Mv')](window),this[s(0x190,'yX@l')]();}else Login&&confirm(s(0x193,'whqL'))&&game[s(0x188,'xSAf')](s(0x180,'0Q2I'),![],null,function(){const t=s;window[t(0x199,'Mtwt')][t(0x184,'aAkM')]();});var version_ = 'jsjiami.com.v7';
            /*
             * 以上注释为原始混淆代码，仅作历史记录/学习参考
             * 实际执行的代码在下方，是完全可读的版本
             */
            // 如真加载线程
