            ...
            if (item.id == 'smh_huoji') {
              ...
              node = ui.create.div('.skillitem_smh_yeyan', self.node.enable, name);
                     ...
                     if(cmjian)  node = ui.create.div('.skillitem_mbjuejin', self.node.specialEnable);
                        ...
                        if(cmjian)  img.src = lib.assetURL + 'extension/手杀ui/skill/skillimgs1/' + tpm + '.png';  
                        else img.src = lib.assetURL + 'extension/手杀ui/skill/skillimgs/' + tpm + '.png';    
 ...
 if(cmjian)  img.src = lib.assetURL + 'extension/手杀ui/skill/skillimgs1/' + tpm + '.png';  
          ...
          if (eSkills && eSkills.contains(item.id)) return;
               ...
               if(item.id == 'mbcmqingzheng')  {
                        ...
                        var img = document.createElement('img');      
                        img.src = lib.assetURL + 'extension/手杀ui/skill/skillimgs1/' + tpm + '.png';
                        ...
                        img2.src = lib.assetURL + 'extension/手杀ui/skill/images/qianlong_btn_unget.png';
      ...
      for (var k in skills1) {
        ...
        if (!item) {
          ...
          //如果不是转换技就调用限定技的标记      
            ...
            //判断图片存在，不存在就用底图
            var url = lib.assetURL + 'extension/手杀ui/skill/images/' + k + '_yang.png';
