...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			zheji_append:'<span class="text" style="font-family: yuanli">不要因为手快而装给自己。</span>',
			//serafuku:'水手服',
			...
			nvzhuang:'女装',
			nvzhuang_info:'锁定技。当你成为【杀】的目标后，若你的性别包含男性，则你进行判定：若结果为黑色，则此牌对你的伤害值基数+1。',
			nvzhuang_append:'<span class="text" style="font-family: yuanli">据野史记载，送给司马懿的女装就是月英穿剩下的。（bushi）</span>',
			yinfengyi:'引蜂衣',
			yinfengyi_info:'锁定技。当你受到渠道为锦囊牌的伤害时，此伤害+1。当你因〖毒①〗而失去体力时，失去体力的量值+1。',
			numa:'驽马',
			numa_info:'锁定技。①你至其他角色的距离-1。②其他角色至你的距离视为1。',
			zhanxiang:'战象',
