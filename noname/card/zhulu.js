...
game.import('card',function(lib,game,ui,get,ai,_status){
	return {
		...
		card:{
				...
				ai:{
					...
					result:{
						...
						target:function(player,target){
							...
							if(cards.length==1&&cards[0].name=='serafuku') return 0;
			...
			serafuku:{//nvzhuang
				...
				onLose:function(){
					...
					var next=game.createEvent('serafuku_lose');
				...
				ai:{
					...
					value:function(){
						return lib.card.serafuku.ai.equipValue.apply(this,arguments);
					},
					basic:{
						equipValue:5,
					},
		...
		translate:{
			...
			serafuku:'水手服',
			serafuku_info:'此牌的使用目标为其他角色。锁定技，当此牌进入或离开你的装备区时，若你的性别为男性，你弃置一张不为此牌的牌。',
			...
			duanjian:'断剑',
			duanjian_info:'此牌的使用目标为其他角色。这是一把坏掉的武器...',
			wufengjian:'无锋剑',
			...
			yonglv:'庸驴',
			yonglv_info:'此牌的使用目标为其他角色。锁定技，当此牌进入你的装备区时，你弃置装备区内的所有其他牌。',
