window.noname_update={
	...
	update:'1.10.1',
	changeLog:[
'● 「游戏本体」新增功能，优化机制和弹窗，修复贴图特效显示及代码错误',
'● 「如真似幻」修复登录界面问题，新增启动动画、大厅主题及玩家头像等的切换，跳转流畅优化',
'● 「 手杀 U I 」优化详情页显示，修复菜篮子功能和一些报错、按键显示错误或丢失问题',
'● 「太虚幻境」优化机制，修复显示、代码和成就错误',
'● 「千幻聆音」优化功能，修复武将菜单和菜篮子冲突的错误',
'<div class=\"linetext\" style=\"text-align:right\">感谢 @小宁 为琉璃版测试BUG！</div>',
