...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterSort:{
			jsrg:{
				jiangshanrugu_qi:['jsrg_liuhong','jsrg_hejin','jsrg_sunjian','jsrg_huangfusong','jsrg_xushao','jsrg_dongbai','jsrg_qiaoxuan','jsrg_yangbiao','jsrg_kongrong','jsrg_zhujun','jsrg_liubei','jsrg_wangyun','jsrg_liuyan','jsrg_nanhualaoxian'],
				jiangshanrugu_cheng:['jsrg_xuyou','jsrg_lvbu','jsrg_zhanghe','jsrg_zoushi','jsrg_guanyu','jsrg_chendeng','jsrg_zhenji','jsrg_zhangliao','jsrg_xugong','jsrg_chunyuqiong'],
			    jiangshanrugu_meng:['jsrg_caocao','jsrg_sunce','jsrg_guojia','jsrg_zhugeliang','jsrg_simazhao','jin_jsrg_simazhao'],
			},
		},
		character:{
			//起
            ...
            jsrg_simazhao:['male','wei',4,['jsrgqiantun','jsrgxiezheng','jsrgzhaoxiong'],['zhu']],
			jin_jsrg_simazhao:['male','jin',4,['jsrgweisi','jsrgxiezheng','jsrgdangyi'],['zhu','forbidai']],
		...
		characterIntro:{
		    ...
		    jsrg_zhugeliang:'建兴六年春，汉丞相诸葛亮使赵云、邓芝为先锋，马谡为副将拒箕谷，牵制曹真主力。自率三十万大军攻祁山，三郡叛魏应亮，关中响震。曹叡命张郃拒亮，亮使定军山降将姜维与郃战于街亭，张郃久攻不下，曹真主动出击，强攻赵云军，赵云死战，坚守箕谷，马谡、邓芝当场战死忠勇殉国。……既克张郃，曹真溃逃，曹叡弃守长安，迁都邺城。十月，司马懿击退孙权，回援曹真。而后三年，丞相所到之处无不望风而降，百姓皆箪食壶浆以迎汉军。尽收豫、徐、兖、并之地，建兴十年春，司马懿父子三人死于诸葛武侯火计，同年，孙权上表称臣，至此四海清平，大汉一统。而后诸葛亮荐蒋琬为丞相，姜维为大将军，自回隆中归隐，后主挽留再三，皆不受。魏延亦辞官相随，侍奉左右。后主时有不决之事，便往隆中拜访相父，均未得面，童子答曰外出云游，留下锦囊数个，拆开视之，皆治国良策也。',
		    jsrg_simazhao:'司马昭，字子上，早年受荫庇于父兄，不慕霸业。及父兄殂谢，昭承继家业，负谋魏自立之责，野心渐起，虽心气才学不及父兄，仍殚竭经营大业，笼人心，除异己，欲令百官贵胄俯首。唯诸葛诞拥兵自重，独据淮南，昭恐其不利于宗族大业，欲除之以建战功，威服四方。昭乃使计逼反诸葛诞，又担忧曹髦为乱后方，乃挟之以同征淮南，临戎除逆。昭惯施权谋，建高墙于寿春城外，围而不攻，为彰显恩德围城期间每有归降者，皆宽赦旧罪。昭收服叛逃倒戈者众，诞、鸯等屡次突围皆大败而归。昭自觉宗族夙愿将成之际，雷声滚滚，大雨倾盆，围墙塌落，魏军困于泥沼，诸葛诞趁势突围，文鸯乘乱欲劫天子。昭恐宗族大业尽毁于己手，积怨缠身，方寸惊乱，亲率三军攻城，誓荡平淮南，讨灭天下不臣，成大业，慰父兄。',
		    jin_jsrg_simazhao:'司马昭，字子上，早年受荫庇于父兄，不慕霸业。及父兄殂谢，昭承继家业，负谋魏自立之责，野心渐起，虽心气才学不及父兄，仍殚竭经营大业，笼人心，除异己，欲令百官贵胄俯首。唯诸葛诞拥兵自重，独据淮南，昭恐其不利于宗族大业，欲除之以建战功，威服四方。昭乃使计逼反诸葛诞，又担忧曹髦为乱后方，乃挟之以同征淮南，临戎除逆。昭惯施权谋，建高墙于寿春城外，围而不攻，为彰显恩德围城期间每有归降者，皆宽赦旧罪。昭收服叛逃倒戈者众，诞、鸯等屡次突围皆大败而归。昭自觉宗族夙愿将成之际，雷声滚滚，大雨倾盆，围墙塌落，魏军困于泥沼，诸葛诞趁势突围，文鸯乘乱欲劫天子。昭恐宗族大业尽毁于己手，积怨缠身，方寸惊乱，亲率三军攻城，誓荡平淮南，讨灭天下不臣，成大业，慰父兄。',
		},
		characterTitle:{
    		jsrg_liuhong: '#y轧庭焚礼',
    		jsrg_hejin: '#y独意误国谋',
    		jsrg_sunjian: '#y拨定烈志',
    		jsrg_huangfusong: '#y安危定倾',
    		jsrg_xushao: '#y识人读心',
    		jsrg_dongbai: '#y魔姬',
    		jsrg_qiaoxuan: '#y泛爱博容',
    		jsrg_yangbiao: '#y德彰海内',
    		...
    		jsrg_chendeng: '#y惊涛弄潮',
    		jsrg_zhenji: '#y一顾倾国',
    		jsrg_zhangliao: '#y利刃风骑',
    		jsrg_xugong: '#y独计击流',
    		jsrg_chunyuqiong: '#y乌巢酒仙',
    		jsrg_caocao: '#y汉征西将军',
    		jsrg_sunce: '#y问鼎的霸王',
    		jsrg_guojia: '#y赤壁的先知',
    		jsrg_zhugeliang: '#y炎汉忠魂',
    		jsrg_simazhao: '#y堕节肇业',
    		jin_jsrg_simazhao: '#y独祅吞天',
		},
		perfectPair:{},
		card:{
		},
		...
		skill:{
            ...
            jsrgweisi: {
                ...
                subSkill: {
                    ...
                    damage: {
                        ...
                        direct: true,
                        filter: function(event, player) {
                            return event.card?.storage?.jsrgweisi;
                        },
                        content: function() {
                ...
                content: function() {
                    ...
                    target.chooseCard("将任意张手牌移出游戏直到本回合结束", [1, Infinity], "h")
                        .set("ai", card => {
                        var {
                            numx, player
                        } = _status.event;
                    ...
                    if (result.bool) {
                        var target = event.target;
                        var next = target.addToExpansion(result.cards, "giveAuto", target);
                        next.gaintag.add("jsrgweisi");
                        target.addTempSkill("jsrgweisi_gain");
                    }
                    "step 2"
                    var target = event.target;
                    var card = {
            ...
            jsrgdangyi: {
                init(player, skill) {
                    ...
                    player.addMark(skill, player.getDamagedHp()+1, false);
                },
                zhuSkill: true,
                trigger: {
                    source: "damageBegin1",
                ...
                check(event, player) {
                    return (
                    get.attitude(player, event.player) < 0 && !event.player.hasSkillTag("filterDamage", null, {
                        player: player,
                        card: event.card,
                    }));
                },
            ...
            jsrgzhaoxiong: {
                ...
                content: function() {
                    ...
                    player.changePlayerTo('jsrg_simazhao','jin_jsrg_simazhao');
                    "step 1"
                    player.removeSkill("jsrgqiantun");
                    //这个就不能换肤了player.changeAvatarTo('jsrg_simazhao','jin_jsrg_simazhao');
                    //lib.translate["jsrgxiezheng"]="挟征2级";
                    dcdAnim.loadSpine(xixiguagua.SS_smz_fadongjineng.name, "skel", function () {
                        dcdAnim.playSpine(xixiguagua.SS_smz_fadongjineng, { speed: 0.7, scale: 1 });
                        game.playAudio('../extension/标记补充/audio/effect_simazhao_skill.mp3');
                    });
                    //player.storage.jsrgxiezheng2=true;
                    "step 2"
            ...
            jsrgqiantun: {
                ...
                content: function() {
                    "step 0"
                    var cards = target.getCards("h").sort((a, b) => get.number(a, target) - get.number(b, target));
                    target.chooseCard("展示任意张手牌，只能用这些牌拼点", [1, Infinity], "h", true)
                    ...
                    next.set("filterCard", (card, player) => {
                        var bool = cardx => cardx.hasGaintag("jsrgqiantun_tag");
                        return !player?.countCards("h", bool) || bool(card);
                    });
                    if (target.countCards("h") + 1 > event.cardx.length * 2) next.set("small", true);
                    "step 3"
                    if (result.winner == player) {
                        var cards = target.getCards("h", card => event.cardx.includes(card));
            ...
            jsrgxiezheng: {
                ...
                content: function() {
                    "step 0"
                    player.chooseTarget(get.prompt2("jsrgxiezheng"), [1, 3], function(card, player, target) {
                        ...
                        }) && (player.hp > 2 || !player.hasAllHistory("useSkill", evt => {
                        ...
                        if (target.hasSha()/*target.mayHaveSha(player, null, null, "odds") > 0.5*/) val *= 2;
                        return val;
                    });
                    "step 1"
                    if(!result?.bool){
                    ...
                    player.logSkill("jsrgxiezheng", result.targets);
                    event.targets = result.targets.sortBySeat();
                    event.count = 0;
                    "step 2"
                    var target = event.targets[event.count];
                    if (!target.countCards("h")) return;
                    if(!player.storage.jsrgxiezheng2){
                        target.chooseCard("h", true, "将一张手牌置于牌堆顶").set("targetx", player).set("ai", card => {
                            var {
                                player, targetx
                            } = _status.event;
                            let att = 0;
                    ...
                    if (!game.hasPlayer2(current => {
                        return current.getHistory("damage", evt => evt.getParent("binglinchengxiax")?.card?.xiezheng).length;
                    })) player.loseHp();
                },
            },
			//淳于琼
			...
			jsrgxundao:{
				...
				content:function(){
					...
					if(player.judging[0].clone){
						...
						},player.judging[0],event.card,player);
					...
					game.log(player,'的判定牌改为',event.card);
					game.delay(2);
				},
				ai:{
					rejudge:true,
			...
			jsrgwentian:{
		        audio:2,
                trigger:{player:['phaseZhunbeiBegin','phaseJudgeEnd','phaseDrawEnd','phaseUseEnd','phaseDiscardEnd','phaseJieshuEnd']},
                filter:function(event,player){
                ...
                content: function () {
                    ...
                    player.chooseButton(['问天：请选择要交出的牌', cards], 1, true);
                    'step 1'
                    if (result.bool) {
                    ...
                    'step 2'
                    if (result.bool) {
                        result.targets[0].gain(event.gives, player, 'give').giver = player;
                    }
                    'step 3'
                    game.delayx();
                    game.updateRoundNumber();
                ...
                subSkill:{
                    ...
                    use:{
                        ...
                        filter:function(event,player){
                            ...
                            if(filter({name:'huogong'},player,event)&&!player.hasSkill('jsrgwentian_block2')) return true;
                            return false;
                        },
                        hiddenCard:function(player,name){
                        ...
                        chooseButton:{
                            dialog:function(event,player){
                                var cards = get.cards();
                                var dialog = ui.create.dialog('问天', cards);
                                //放回去，防止刷牌
                                var first = ui.cardPile.firstChild;
                                ui.cardPile.insertBefore(cards[0],first);
                            ...
                            backup:function(links,player){
                                return {
                                    ...
                                    selectCard:-1,
                                    viewAs:{name:'huogong',cards:links,isCard:true},
                                    forced: true,
                                    precontent:function(){
                                        delete event.result.skill;
                    ...
                    use2:{
                        ...
                        filter:function(event,player){
                            var filter=event.filterCard;
                            if(filter({name:'wuxie'},player,event)&&!player.hasSkill('jsrgwentian_block2')) return true;
                            return false;
                        },
                        hiddenCard:function(player,name){
                        ...
                        chooseButton:{
                            ...
                            backup:function(links,player){
                                return {
                                    filterCard:function(){return false},
                                    selectCard:-1,
                                    viewAs:{name:'wuxie',cards:links,isCard:true},
                                    precontent:function(){
                                        delete event.result.skill;
                                        event.getParent().addCount=false;
                                        var cards=event.result.card.cards
            ...
            jsrgchushi:{
                ...
                content:function() {
                    ...
                    player.chooseToDebate(targets).set('callback', function () {
                        var result = event.debateResult;
                        if (result.bool && result.opinion) {
                            var opinion = result.opinion, player = event.player;
                            if (opinion == 'red') {
                ...
                subSkill:{
                    cancel:{
                        ...
                        direct:true,
                        charlotte:true,
                        filter:function(event,player){return player.hasSkill('jsrgchushi_power')},
                        content:function(){
            ...
            jsrgyinlue:{
                init:function(player){
                    player.storage.jsrgyinlue=[0,0];
                },
		        audio:2,
                trigger:{global:'damageBegin3'},
                filter:function(event,player){
                    if(!event.nature) return false;
                    if(event.nature=='fire') return player.storage.jsrgyinlue[0]==0;
                    else if(event.nature=='thunder') return player.storage.jsrgyinlue[1]==0;
                },
                content:function(){
                    if(trigger.nature=='fire'){
                        player.addSkill('jsrgyinlue_fire');
                        player.storage.jsrgyinlue[0]=1;
                    }
                    else if(trigger.nature=='thunder'){
                        player.addSkill('jsrgyinlue_thunder');
                        player.storage.jsrgyinlue[1]=1;
                    }
                    trigger.cancel();
                },
                subSkill:{
            ...
            jsrgzhenfeng:{
                ...
                mod:{
                    cardUsable:function (card,player,num,storage){
                        if(card.noCount) return Infinity;
                    },
                },
                chooseButton:{
                    dialog:function(event,player){
                        ...
                        return {
                            ...
                            onuse:function(result,player){
                                ...
                                switch(get.type(result.card.name)){
                                    case 'basic':player.storage.jsrgzhenfeng1[0]=1;break;
                                    default:player.storage.jsrgzhenfeng1[1]=1;break;
                                }
                            },
                        }
                    },
		...
		translate:{
            ...
            jsrgdingce:'定策',
            jsrgdingce_info:'当你受到伤害后，你可以弃置你和伤害来源各一张手牌，若这两张牌颜色相同，视为你使用一张【洞烛先机】。',
            jsrgzhenfeng:'针锋',
            jsrgzhenfeng_info:'出牌阶段每种类型的牌限一次，你可以视为使用一张存活角色技能中包含的牌名（无次数距离限制且须为基本牌或普通锦囊牌）；当此牌对该角色生效后，你对其造成1点伤害。',
            
            jsrg_simazhao:'梦司马昭',
            jin_jsrg_simazhao:'梦司马昭',
            jsrgqiantun: "谦吞",
            jsrgqiantun_info: "出牌阶段限一次，你可以令一名其他角色展示至少一张手牌并与其拼点，其只能从展示牌中选择拼点牌。若你赢，你获得其展示的手牌；若你没赢，你获得其未展示的手牌。然后你展示手牌。",
            jsrgqiantun_tag: "invisible",
            jsrgxiezheng: "挟征",
            jsrgxiezheng_info: "结束阶段，你可以令至多三名角色依次将一张手牌置于牌堆顶，然后你视为使用一张【兵临城下】，结算结束后若你未因此造成伤害，你失去1点体力。",
            jsrgzhaoxiong: "昭凶",
            jsrgzhaoxiong_info: "持恒技，限定技。准备阶段，若你已受伤且发动过〖挟征〗，你可以变更势力至晋，失去〖谦吞〗，然后你获得获得技能〖威肆〗和〖荡异〗。",
            jsrgweisi: "威肆",
            jsrgweisi_info: "出牌阶段限一次，你可以选择一名其他角色，令其选择任意张手牌移出游戏直到回合结束，然后视为对其使用一张【决斗】，此牌对其造成伤害后，你获得其所有手牌。",
            jsrgdangyi: "荡异",
            jsrgdangyi_info: "持恒技，主公技。每局游戏限X次（X为你获得此技能时已损失的体力值+1），你造成伤害时可以令此伤害+1。",
            

			jiangshanrugu_qi:'江山如故·起',
			jiangshanrugu_cheng:'江山如故·承',
			jiangshanrugu_meng:'江山如故·梦',
		},
	};
});
