...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterTitle:{
    		...
    		zhangjiao: '#y大贤良师',
    		old_zhugezhan: '#y决战邓艾',
    		old_guanqiujian: '#y攻破东川',
    		xiahouyuan: '#y疾行的猎豹',
    		weiyan: '#y嗜血的独狼',
    		old_xiaoqiao: '#y花好月圆',
    		pangde: '#y人马一体',
    		xuhuang: '#y周亚夫之风',
    		junk_sunquan: '#y历战年兽', //这个是标孙权的皮肤
    		huangzhong: '#y老当益壮',
    		new_caoren: '#y神勇可撼',
    		old_chendao: '#y白毦统领',
    		old_zhangfei: '#y智擒严颜',
    		...
    		jsp_caoren: '#y坚不可摧',
    		ol_guansuo: '#y倜傥孑侠',
    		old_zhangxingcai: '#y将门红妆',
    		old_huangfusong: '#y志定雪霜',
    		old_wangyun: '#y连计将成',
    		old_dingfeng: '#y清侧重臣',
    		junk_simayi: '#y三狼吞魏', //这个其实是神司马懿的皮肤
    		old_yangyan: '#y妍芷艳质',
    		old_yangzhi: '#y妍芷艳质',
    		old_caochun: '#y长坂败备',
    		old_majun: '#y名巧天下',
			...
			junkguixin:{
				...
				content_获得技能:function(){
					...
					if(result.bool){
						...
						player.addZhuSkill(result.links[0],'junkguixin');
					}
				},
