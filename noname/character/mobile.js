...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterSort:{
			mobile:{
				mobile_default:['xin_guozhao',"miheng","taoqian","lingcao","sunru","lifeng","zhuling","liuye","zhaotongzhaoguang","majun","simazhao","wangyuanji","pangdegong","shenpei","hujinding","zhangyis","jiakui","yangbiao","chendeng","dongcheng","yangyi","dengzhi","zhengxuan","sp_sufei","furong","dingyuan","simashi","yanghuiyu","hucheer","gongsunkang","nanhualaoxian","zhouqun","qiaozhou","fuqian","simafu","mayuanyi","yanpu","sunhanhua","sp_maojie","peixiu","sp_jianggan","ruanhui","xin_mamidi","sp_caosong","yangfu","wangjun","sp_pengyang","qianzhao",'shichangshi'],
				mobile_yijiang:["yj_zhanghe","yj_zhangliao","yj_xuhuang","yj_ganning",'yj_huangzhong','yj_weiyan','yj_caoren','yj_yuanshu'],
				...
				mobile_dragon:['mb_caomao','mb_epic_caomao','mb_wangjing'],
				...
				mobile_sp:["old_yuanshu","re_wangyun","re_baosanniang","re_weiwenzhugezhi","re_zhanggong","re_xugong","re_heqi","liuzan","xin_hansui","mb_qinghegongzhu","mb_zhangfen"],
			    mobile_pot:["pot_taishici","pot_yuji","pot_weiyan"],
    			mobile_laoyouji: ["friend_zhugeliang", "friend_xushu", "friend_pangtong", "friend_cuijun", "friend_shitao"],
            },
		},
		character:{
			friend_cuijun: ["male", "qun", 4, ["friendshunyi", "friendbiwei", "friendgongli_cuijun"]], 
            ...
            pot_weiyan: ["male", "shu", 4, ["potzhongao", "potzhuangshi", "potyinzhan"]],
            pot_weiyan_achieve: ["male", "shu", 4, ["potzhongao", "potzhuangshi", "potyinzhan"], ["unseen"]],
            pot_weiyan_fail: ["male", "shu", 4, ["potzhongao", "potzhuangshi", "potyinzhan"], ["unseen"]],
			...
			mb_epic_caomao:['male','wei',3,['mbcmqingzheng','mbcmjiushi','mbcmfangzhu','mbjuejin','mbweitong'],['zhu', 'forbidai']],
			mb_wangjing: ["male", "wei", 3, ["mbzujin", "mbjiejian"]],
	        yj_yuanshu:['male','qun',4,['dccanxi','dcpizhi','dczhonggu'],['zhu']],
            yj_caoren:['male','wei',4,['dcsujun','dclifeng']],
		...
		characterIntro:{
			...
			zhangyis:'张翼（？－264年），字伯恭，益州犍为郡武阳县人。三国时期蜀汉将领。历任梓潼、广汉、蜀郡三郡太守，出任庲降都督，后随诸葛亮和姜维北伐，官至左车骑将军，领冀州刺史。初封关内侯，进爵都亭侯。蜀汉灭亡后，魏将钟会密谋造反，成都大乱，张翼亦为乱兵所杀。张翼是蜀汉第三任庲降都督，由于执法严厉，不得南夷欢心。在北伐上，张翼认为国小民疲，不应滥用武力，是蜀汉朝廷当时极少敢当朝和姜维争辩北伐问题的大臣。',
	    	...
	    	friend_cuijun:"崔钧，字元平，博陵安平（今河北安平）人，太尉崔烈之子，与崔州平为同一人，其兄为议郎崔均。历任虎贲中郎将、西河太守，因父买官之事与父不和，后因参加董卓讨伐战，其父被董卓所杀，他本人则游历于荆襄之地，与诸葛亮、徐庶等人交善。",
	        pot_weiyan_achieve:'字文长，义阳人。三国时期蜀汉名将，诸葛亮死后，魏延因被陷害谋反而遭杨仪一党所杀。',
			pot_weiyan_fail:'字文长，义阳人。三国时期蜀汉名将，诸葛亮死后，魏延因被陷害谋反而遭杨仪一党所杀。',
		},
		characterTitle:{
    		xin_guozhao: '#y文德皇后',
    		miheng: '#y鸷鹗啄孤凤',
    		...
    		xin_zhuran: '#y不动之督',
    		xin_guohuai: '#y垂问秦雍',
    		xin_panzhangmazhong: '#y擒龙伏虎',
    		xin_fuhuanghou: '#y孤注一掷',
    		re_yufan: '#y狂直之士',
    		xin_zhoucang: '#y披肝沥胆',
    		xin_caifuren: '#y襄江的蒲苇',
    		xin_guyong: '#y庙堂的玉磐',
    		...
    		old_yuanshu: '#y南方霸主',
    		re_wangyun: '#y忠魂不泯',
    		re_baosanniang: '#y南中武娘',
    		re_weiwenzhugezhi: '#y帆至夷洲',
    		re_zhanggong: '#y西域长歌',
    		re_xugong: '#y独计击流',
    		re_heqi: '#y马踏群峦',
    		liuzan: '#y啸天亢声',
    		xin_hansui: '#y雄踞北疆',
    		mb_qinghegongzhu: '#y蛊虿之谗',
    		mb_zhangfen: '#y究械菁杰',
    		pot_taishici: '#y志踏天阶',
    		pot_yuji: '#y夙仙望道',
    		pot_weiyan: '#y矜忠跨万山',
    		friend_zhugeliang: '#y龙骧九天',
    		friend_xushu: '#y潜悟诲人',
    		friend_pangtong: '#y凤翥南地',
    		friend_cuijun: '#y日奋金丝',
    		friend_shitao: '#y月堕窠臼',
		},
		card:{
			'dagongche_attack': {
				...
				onEquip:function(){
				    game.playAudio('mb_zhangfen', 'equip');
				    lib.skill.mbquchong.setDurability(card, 'show', player);
				},
				onLose:function(){
				    lib.skill.mbquchong.setDurability(card, 'hide', player);
				},
			},
			'dagongche_defense': {
				fullskin: true,
		...
		skill:{
            ...
            mbquchong: {
				...
				setDurability: function(card, num, addition) {
				    if(get.itemtype(card) != 'card') return false;
				    var card, player;
				    if(get.itemtype(addition) == 'player') {
    					player = addition;
				    }else {
				        player = get.owner(card);
				        if(!player) return false;
				    }
				    var durabilityFrom = card.getAttribute('durability');
				    if(typeof num == 'number') {
				        card.setAttribute('durability', num);
				    }else if(typeof num == 'string' && (num[0] == '+' || num[0] == '-')) {
				        var z = num[0] == '+' ? 1 : -1;
				        var chg = parseInt(num.slice(1));
				        card.setAttribute('durability', parseInt(durabilityFrom) + (z * chg));
				    }
				    var durabilityTo = card.getAttribute('durability');
				    if(durabilityFrom != durabilityTo) {
				        var fixed = durabilityFrom - durabilityTo;
				        game.log(card, (fixed < 0 ? "增加" : "减少") + "了", "#y" + Math.abs(fixed) + "点", "#g耐久值");
				    }
				    //这里开始做标记
				    var div;
				    if(!player._dagongche_durability_mark) {
				        div = ui.create.div(player);
				        div.classList.add('dagongche_durability_mark');
				        player._dagongche_durability_mark = div;
				    }else {
				        div = player._dagongche_durability_mark;
				    }
				    if(durabilityTo > 0 && num != 'hide') {
				        div.innerHTML = durabilityTo;
				...
				init: function(player, skill) {
				    game.createCss(`.dagongche_durability_mark {
                        position: absolute;
                        bottom: 6px;
                        /*right: 7px;*/
                        right: calc(40% - 11.5px);
                        opacity: 0.85;
                        height: 23px;
                        width: 23px;
                        background-image: url("${lib.assetURL}image/card/dagongche_durable.png");
				...
				subSkill: {
					...
					create: {
						...
						content: function () {
							...
							var list=[['diamond',1,'dagongche_attack'],['heart',1,'dagongche_defense']];
						    player.chooseButton(['你可消耗' + event.num + '点铸造值建造一种大攻车', [list, 'vcard']]).set('ai', function(button) {
						        return 1+Math.random();
						    });
							'step 1'
							if(result.bool && result.links?.length) {
    							event.control = result.links[0][2];
    							var prompt = event.control == 'dagongche_attack' ? '大攻车·进击' : '大攻车·守御';
    							player.chooseTarget()
    								.set('prompt', '选择一个目标令其使用【'+prompt+'】')
							...
							if(result.bool) {
            				    ...
            				    if(lib.config.effect_mb_zhangfen) {
                				    game.playAnimation('extension/标记补充/animation/mbzhangfen_'+(event.control == 'dagongche_attack' ? 'attack' : 'defense')+'.mp4');
                				    game.delay();
            				    }
            				}else event.goto(0);
            				'step 3'
							...
							event.card = event.control == 'dagongche_attack' ? game.createCard('dagongche_attack', 'heart', 1) : game.createCard('dagongche_defense', 'diamond', 1);
							event.card.setAttribute('id', player.playerid);
							//event.card.setAttribute('durability', event.control == '进击' ? 1 : 3);
							lib.skill.mbquchong.setDurability(event.card, event.control == 'dagongche_attack' ? 2 : 4, event.target);
					...
					move: {
						...
						content: function () {
							...
							if (result.bool) {
								...
								//event.durability = event.card.getAttribute('durability');
			...
			dagongche_defense_skill: {
				...
				forced: true,
				content: function () {
					game.playAudio('mb_zhangfen', 'defense');
					...
					lib.skill.mbquchong.setDurability(card, `-${numx}`);
					trigger.num -= numx;
				},
			},
			dagongche_ban: {
			...
			dagongche_lose: {
				...
				content: function () {
					...
					lib.skill.mbquchong.setDurability(card, '-1');
			...
			dagongche_destroy: {
				...
				content: function () {
					...
					card.destroyed = true;
					game.log(card,'被销毁了');
					game.playAudio('mb_zhangfen', 'lose');
				},
			},
			mbxunjie: {
				audio: 2,
        		...
        		subSkill: {
        			...
        			achieve: {
        				...
        				content() {
        					...
        					if(lib.config.extension_十周年UI_enable && lib.config.effect_pot_weiyan) {
                                _status.tempMusic='effect_yinzhanBGM';
                                game.playBackgroundMusic();
                                decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
                                decadeUI.animation.playSpine({ name: "SS_ShiWeiYanSkill", action: "play2" }, { scale: 1.2 });
                                if(player.name=='pot_weiyan' && !player.name2) setTimeout(function() {
                                    decadeUI.animation.playSpine({ name: "SS_SWY_zhuangtai31hongyan" },  { referFollow: true, parent: player, loop: true, x: [0, 0.6], y: [0, 0.36], scale: 1.07 });
                                }, 4000);
                                game.delay(4);
                            }
        					player.changePlayerTo("pot_weiyan", "pot_weiyan_achieve");
        					player.setStorage("potkuanggu", 1);
        					event.num = player.countMark("potzhuangshi_limit") + player.countMark("potzhuangshi_directHit");
        					"step 1"
        					if (event.num > 0) {
        						if (!player.isDamaged()) {
        			...
        			fail: {
        				...
        				content() {
        					...
        					if(lib.config.extension_十周年UI_enable && lib.config.effect_pot_weiyan) {
                                ...
                                game.playBackgroundMusic();
                                decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
                                decadeUI.animation.playSpine({ name: "SS_ShiWeiYanSkill", action: "play1" }, { scale: 1.2 });
                                game.delay(4);
                            }
        					player.changePlayerTo("pot_weiyan", "pot_weiyan_fail");
        					"step 1"
        					player.changeSkills(["kunfen"], ["potzhuangshi"]);
        					"step 2"
        					player.recover();
        					"step 3"
        					player.draw(2);
        					"step 4"
        					if(trigger.name == "dying" && player.getHp()>0) {
        	...
        	potzhuangshi: {
        		...
        		content() {
    				...
    				"step 1"
				    event.cost_data = result.bool ? result.links : "nouse";
				    player.logSkill("potzhuangshi");
				    "step 2"
        			...
        			event.finish();
        			"step 5"
        			if(event.cost_data.includes("losehp")) {
        			    event.numList = [];
        			    for(var i=1; i<=player.getHp(); i++) {
        			        event.numList.push(i);
        			    }
        			    if(lib.config.extension_选将美化_enable) {
                            ...
                            var index = event.numList.length - 1;                     
                            var list=event.numList;                  
                            chooseType.innerHTML = list[index];
                            player.storage.potzhuangshi_mark = index;         
                            if (index <= 0) leftBtn.style.filter = 'grayscale(100%)';
                            else leftBtn.style.filter = 'none';
                            if (index >= event.numList.length - 1) rightBtn.style.filter = 'grayscale(100%)';
                            ...
                            rightBtn.listen(function () {
                                if (index == event.numList.length - 1) return;
                                index++;
                            ...
                            player.chooseBool('失去任意点体力值，令你此阶段使用的前等量张牌不计入次数限制', true)
                            .set('ai', function() {return true;});
                        }else {
                            player.chooseControl(event.numList)
                            .set('prompt','失去任意点体力值，令你此阶段使用的前等量张牌不计入次数限制')
                            .set("ai", () => {
    							const player = get.player();
                    ...
                    "step 6"
    			    if(lib.config.extension_选将美化_enable) {
    			        if (player.storage.potzhuangshi_mark) {
        			        var number=player.storage.potzhuangshi_mark;
        			        player.loseHp(number + 1);
                    ...
                    "step 7"
    				if (event.cost_data.includes("discard")) {
    					player.chooseToDiscard(get.translation(event.name), [1, Infinity], "h", true)
					...
					"step 9"
					var number = result.cards.length;
        		...
        		content() {
        			...
        			if (bool2) {
        				...
        				player.addWhen({
        				    ...
        				    bool: bool1,
        				    target: target,
        				    triggerGetParent: trigger.getParent(2),
        				    filter: function(event, player) {
        				        if(!_when.target.isIn() || !_when.target.countCards("he")) {
        				            _when.cancel();
        				            return false;
        				        }
        				        return event == _when.triggerGetParent;
        				    },
        				    content: function() {
    							"STEP 0"
    							player.discardPlayerCard(_when.target, "he", true);
    							"STEP 1"
    							if(_when.bool && result.cards) {
        	...
        	potkuanggu: {
        		...
        		filter(event, player) {
        			return /*event.checkKuanggu*/get.distance(player, event.player) <= 1 && event.num > 0;
        		},
        		frequent: true,
        		popup: false,
        		...
        		content() {
        			...
        			if (list.length == 1) {
        				player.chooseBool(get.prompt('potkuanggu'), "摸一张牌").set("frequentSkill", event.skill);
        				event.cost_data = "draw_card";
        				event.goto(1);
        			} else {
        				list.push("cancel2");
        				if (
        			...
        			if(result.control != 'cancel2') {
        			    event.cost_data = result.control;
        			}else {
        			    event.finish();
        			}
        			'step 3'
        			player.logSkill('potkuanggu');
        			if (lib.config.extension_十周年UI_enable && lib.config.effect_pot_weiyan) {
            			setTimeout(function() {
                			if(!player.getStorage('potkuanggu', 0)) {
                                decadeUI.animation.playSpine({ name: "SS_ShiWeiyanFaDongSkill", action: "play1", speed: 1.2 }, { x: [0, 0.55], y: [0, 0.57], scale: 0.9, parent: player });
                            }else {
                                decadeUI.animation.playSpine({ name: "SS_ShiWeiyanFaDongSkill", action: "play2", speed: 1.2 }, { x: [0, 0.55], y: [0, 0.5], scale: 0.85, parent: player });
                            }
                        }, 200);
                    }
        			if (event.cost_data == "recover_hp" || event.cost_data == "背水！") {
        				player.recover();
        			}
        			'step 4'
        			if (event.cost_data == "draw_card" || event.cost_data == "背水！") {
        				player.draw();
        			}
        			'step 5'
        			if (event.cost_data == "背水！" && player.countCards("he")) {
        				player.chooseToDiscard("he", true);
        			}else {
        			    event.finish();
        			}
        			'step 6'
    				player.addTempSkill("potkuanggu_effect");
        	...
        	friendshunyi: {
        		...
        		filter(event, player, name) {
        			...
        			if(typeof number!='number' || number <= player.countMark('friendshunyi_mark')) return false;
        			//if (!player.hasCard({ suit: suit }, "h")) return false;
        			const cards = player.getCards("h").unique().filter(i => {
        				return i !== card && typeof get.number(i, player) === "number";
        			});
        			return !cards.length || number < Math.min(...cards.map(i => i!=card && get.number(i, player)));
        		},
        		...
        		check(event, player, name) {
        			...
        			return get.effect(player, { name: "wuzhong" }, player, player) >= used.reduce((sum, i) => sum + player.getUseValue(i), 0);
        		},
        		content() {
        			if(player.hasSkill('friendshunyi_mark')) {
        			    player.addMark('friendshunyi_mark');
        			}else {
        			    player.addTempSkill('friendshunyi_mark');
        			}
        			player.addTempSkill("friendshunyi_effect");
        			const cards = player.getCards("h", { suit: get.suit(trigger.card) });
        		...
        		subSkill: {
        			mark: {
        			    ...
        			    onremove: function(player,skill) {
        			        player.clearMark('friendshunyi_mark');
        			    },
        			    chalotte: true,
        			    /*marktext: '顺逸次数',
        			    intro: {
        				...
        				intro: {
        					...
        					mark(dialog, storage, player) {
        						const cards = player.getExpansions("friendshunyi_effect"),
        					        num = player.countMark('friendshunyi_mark');
        						if (player.isUnderControl(true)) {
        						    dialog.addText("本回合顺逸已发动"+num+"次");
        	...
        	friendbiwei: {
        		...
        		content() {
        			const card = cards[0];
        			const number = get.number(card, player);
        			const cards2 = target.getDiscardableCards(target, "h", i => typeof get.number(i) === "number" && get.number(i) >= number);
        	...
        	friendgongli_cuijun: {
        		...
        		content() {
        			...
        			if(suits.length > num) {
        				player.chooseButton(["共砺：请选择可令〖顺逸〗触发的额外花色", [suits, "vcard"]], true, [1, num])
							.set("ai", () => 1 + Math.random());
					}else {
    					result.links = suits.map(suit => ["", "", suit]);
					}
					'step 1'
        			if (result.links?.length) {
        				...
        				player.markAuto(
        					...
        					result.links.map(i => i[2].slice("lukai_".length))
        				);
        			}
        		},
        		subSkill: {
        	...
        	friendqinying: {
        		...
        		content() {
        			...
        			player.chooseUseTarget({ name: "juedou", isCard: true, storage: { friendqinying: cards.length } }, true).set("zhege",true);
        		},
        		//留给ai优化来修复吧
        		ai: {
        			order(item, player) {
        			...
        			result: {
        				player(player) {
        					const card = { name: "juedou", isCard: true, storage: { friendqinying: true } };
        					let target = null,
        						maxval = 0;
        		...
        		subSkill: {
        			...
        			global: {
        				...
        				filter(event, player) {
        					if (event.friendqinying || !event.parent || (event.parent?.card?.storage?.friendqinying ?? 0) < 1) return false;
        				...
        				prompt() {
        					...
        					const source = event.player,
        						types = source.getStorage("friendgongli_shitao_qinying");
        					return '<span class="text center">' + ["此流程还可发动" + event.card.storage.friendqinying + "次本效果", "弃置区域里的一张" + (types.length > 0 ? "非" + get.translation(types) : "") + "牌，视为打出【杀】"].map(str => "※" + str).join("<br>") + "</span>";
        				},
        				log: false,
        				viewAs: { name: "sha" },
        				precontent() {
        					'step 0'
        					event.ptn = event.getParent().getParent();
        					const types = event.ptn.player.getStorage("friendgongli_shitao_qinying");
        					player.discardPlayerCard(player, "hej", true)
        						...
        						.set("filterButton", button => !types.includes(get.type2(button.link)));
    						'step 1'
        					if (result.bool) {
        						event.ptn.card.storage.friendqinying--;
        						game.broadcastAll(
        							(card, storage) => {
        								card.storage = storage;
        							},
        							event.ptn.card,
        							event.ptn.card.storage
        						);
        					} else {
        						event.ptn.set("friendqinying", true);
        						event.ptn.goto(0);
        					}
        				},
        				ai: {
        					order(item, player) {
        						const card = { name: "shunshou" };
        	...
        	friendlunxiong: {
        		...
        		check(event, player) {
        			...
        			return get.effect(player, { name: "wuzhong" }, player, player) * 3 > get.value(card, player);
        		},
        		content() {
        			'step 0'
        			const cardx = player.getCards("h", card => typeof get.number(card, player) === "number");
        			...
        			if (card) {
        				event.number = get.number(card, player);
        				player.discard(card);
        			}else {
        			    event.finish();
        			}
    				...
    				player.draw(3);
    				'step 2'
    				player.storage[event.name] = event.number;
        	...
        	friendgongli_shitao: {
        		...
        		content() {
        			...
        			if(types.length > num) {
        				/*player.chooseButton(["共砺：请选择不可令〖钦英〗弃置的类别", [types.map(type => [type, get.translation(type)]), "tdnodes"]], true, [1, num])
							.set("ai", () => 1 + Math.random());*/
						player.chooseButton(["共砺：请选择不可令〖钦英〗弃置的类别", [types, "vcard"]], true, [1, num])
							.set("ai", () => 1 + Math.random());
					}else {
					    result.links = types;
					}
        			...
        			if (result.links?.length) {
        				...
        				player.markAuto("friendgongli_shitao_qinying", result.links.map(link => link[2]));
        			}
        		},
        		subSkill: {
        			qinying: {
        		...
        		subSkill: {
        			gain: {
        				...
        				content() {
        					...
        					player.chooseButton(["###" + get.prompt("friendxiaxing") + '###<div class="text center">移去2枚“启诲”标记，获得' + get.translation(gains) + "</div>", [storage.map(c => [c, get.translation(c)]), "tdnodes"]], 2).set("ai", button => {
        						const player = get.player();
        						if (player.getEquip("xuanjian")) return 0;
        						return (
        							1 +
        							Math.random() +
        					...
        					'step 2'
        					player.unmarkAuto("friendqihui", result.links);
        					player.gain(
        	...
        	friendqihui: {
        		...
        		content() {
        			...
        			player.markAuto(event.skillName, [get.type2(trigger.card)]);
        			'step 1'
        			if (player.getStorage(event.skillName).length < 3) {
        			    event.finish();
        			}
        			'step 2'
    				player.chooseButton(["选择你要移去的“启诲”标记", [player.getStorage(event.skillName), "vcard"]], [2, 2], true).set("ai", button => {
    					const player = get.player();
    					return (
    						1 +
    						Math.random() +
    				...
    				'step 3'
    				if (!result.bool || !result.links?.length) event.finish();
    				'step 4'
    				player.unmarkAuto(
    					event.skillName,
    					result.links.map(link => link[2])
    				);
    				player.chooseButton(
						[
							"启诲：请执行一项",
					...
					.set("ai", button => {
						...
						if (button.link === "draw") return get.effect(player, { name: "wuzhong" }, player, player) * 2;
						return Math.max(
							...[0].concat(
								player
									.getCards("he", card => {
    				...
    				if (result.bool && result.links) {
    					switch (result.links[0]) {
    						...
    						case "draw":
    							...
    							break;
    						default:
    							player.addSkill(event.skillName + "_unlimit");
    					}
    				}
        		},
        		intro: { content: "已记录：$" },
        		...
        		selectCard() {
        			...
        			if (ui.selected.cards.length) {
        				if (!player.hasSkill("friendxushugongli") || !get.info("friendgongli").isFriendOf(player, "friend_zhugeliang")) {
        				    ...
        				    game._tempXuanjian = ui.selected.cards.length;
        				    return -1;
        				}
        			}else {
        			    game._tempXuanjian = 0;
        	...
        	friendmanjuan: {
        		...
        		content() {
        			...
        			player.chooseToMove(get.prompt2("friendmanjuan"))
        				.set("list", [
        					["牌堆顶", []],
        					[["获得的牌"], cards],
        				])
    				...
    				'step 1'
    				if(!result.moved?.length) event.finish();
    				'step 2'
        	...
        	friendyangming: {
        		...
        		content() {
        			...
        			'step 2'
        			if(!event.cards.some(card => player.hasUseTarget(card))) {
        			    event.goto(7);
    			    }
    			    'step 3'
        			player.chooseCardButton(event.cards, "养名：请选择要使用的牌")
    					.set("filterButton", button => {
					...
					'step 6'
					if (result.bool) {
						event.cards.removeArray(event.cards.filter(cardx => get.suit(cardx) === get.suit(event.card)));
						event.goto(2);
					} else {
					    event.goto(7);
					}
					'step 7'
        			if (player.hasSkill("friendpangtonggongli") && get.info("friendgongli").isFriendOf(player, "friend_xushu") && event.cards.length) {
        				player.chooseCardButton(event.cards, "养名：是否获得其中一张牌？").set("ai", button => get.value(button.link));
        			}else {
        			    event.finish();
        			}
        			'step 8'
        	...
        	friendyance: {
        		...
        		content() {
        			"step 0"
        			let prompt2 = get.prompt2("friendyance");
        			player.chooseButton([
    					prompt2.slice(0,prompt2.indexOf('：')+1),
    					[
    						[
    							["trick", `①从牌堆中随机获得一张锦囊牌`],
    							["minigame", `②执行『卧龙演策』`],
						...
						if(_status.currentPhase == player && Math.random() < 0.5) {
						    return button.link == 'minigame';
						}else {
						    return button.link == 'trick';
						}
					});
        			"step 1"
        			if (result.bool) {
        			    ...
        			    if (choice === "trick") {
        				    ...
        				    const next = game.createEvent("friendyance_minigame");
        				    next.player = player;
        				    next.setContent(lib.skill.friendyance.minigame);
        			    }
        			}
        		},
        		...
        		minigame() {
        			...
        			if (typeof player.storage.friendyance !== "number") {
        				let bool = player.hasSkill("friendzhugelianggongli") && lib.skill.friendgongli.isFriendOf(player, "friend_pangtong");
        			...
        			if (result.control) {
        			    ...
        			    const color = Object.keys(lib.color).filter(c=>c!='none');
        			    const list = [];
        			    if (result.control === "颜色预测") {
        				    list.addArray(color);
        				    storage[2] = "color";
        			    } else {
        				    list.addArray(type);
        			    ...
        			    const dialog = ["###卧龙演策###<br>请对将被使用的牌进行预测"];
        			    ...
        			    game.createCss(`.wolongyance_noselect {
        			        pointer-events: none;
        			        opacity: 0.6;
        			    }
        			    .wolongyance_selectButton {
        			        box-shadow: rgba(255, 255, 255, 1) 0 0 1.5px 1.5px;
        			    }`);
        			    player
        				    ...
        				    .set("filterButton", button => {
        					    if(ui.selected.buttons.length > 0) {
        					        for(let i=0;i<ui.selected.buttons.length;i++) {
        					            if(i+1==ui.selected.buttons.length) {
        					                ui.selected.buttons[i].classList.remove('wolongyance_noselect');
        					            }else {
        					                ui.selected.buttons[i].classList.add('wolongyance_noselect');
        					            }
        					        }
        					    }
    					        if(ui.selected.buttons.contains(button)) {
    					            button.classList.add('wolongyance_selectButton');
    					        }else {
    					            button.classList.remove('wolongyance_selectButton');
    					        }
        			...
        			if (result.bool) {
        			    ...
        			    //let target = game.players.filter(item => item.name == "friend_zhugeliang")[0];
        			    if(lib.config.effect_friend_zhugeliang) {
        			        //ui.wolongicon = lib.skill.friendyance.WoLongIcon(links, target, storage[4]);
        			        player.wolongicon = lib.skill.friendyance.WoLongIcon(links, player, storage[4]);
    			        }
        			}
        		},
        		init: function(player, skill) {
                    ...
                    .yance-dialog__content {
                    	position: static;
                    	width: 100%;
                    	/* height: 70%; */
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_bg_juanzhou.png");
                    ...
                    .yance-queding {
                    	...
                    	cursor: pointer;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_btn_queding.png");
                    	background-size: contain;
                    	background-repeat: no-repeat;
                    	background-position: center;
                    	display: flex;
                    ...
                    .yance-process {
                    	position: static;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_bar_01.png");
                    ...
                    .yance-precess2 {
                    	position: static;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_bar_02.png");
                    ...
                    .yance-item-button {
                    	...
                    	margin-top: 5px;
                    	cursor: pointer;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_btn_xuanxiang_02.png");
                    	background-size: cover;
                    	background-repeat: no-repeat;
                    	background-position: center;
                    	width: 90px;
                    ...
                    .yance-item-button-checked {
                    	position: static;
                    
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_btn_xuanxiang_01.png");
                    	background-size: cover;
                    	background-repeat: no-repeat;
                    	background-position: center;
                    }
                    .yance-item-text-checked {
                    	position: static;
                    
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_btn_xuanzhong.png");
                    	background-size: cover;
                    	background-repeat: no-repeat;
                    	background-position: center;
                    }
                    .wlan-bg {
                    	...
                    	top: 0;
                    	left:0;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_jiesuan_bg_di.png");
                    	background-repeat: no-repeat;
                    	z-index: 6;
                        width: 100%;
                        height: 100%;
                    ...
                    .wlan-title {
                    	...
                    	width: 252px;
                    	height: 104px;
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/paiju_wlyc_jiesuan_content_biaotidi.png");
                    	background-repeat: no-repeat;
                    ...
                    .wlan-shiti-dui {
                    	...
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/shixin1.png");
                    	
                    }
                    .wlan-shiti-cuo {
                    	background-image: url("${lib.assetURL}extension/标记补充/image/wolongyance/kongxin1.png");
                    }
                    ...
                    .wlyc-icon-con {
                        ...
                        flex-wrap: nowrap;
                        justify-content: flex-start;
                        animation: popIn 0.3s ease; /* 添加入场动画 */
                    }
        		...
        		WolongYanceEffect(info, dev) {
                    ...
                    const WMWOLONGYANCE = {
                        bagua: {
            				name: xixiguagua.SS_wolongyance_beitu.name,
            				speed: 0.8,
            				scale: 0.8,
            			},
            			kongqiu: {
            				name: xixiguagua.SS_wolongyance_kongqiu.name,
            				speed: 0.8,
            				scale: 0.8,
            			},
            			shiti: {
            				name: xixiguagua.SS_wolongyance_shiti.name,
            				speed: 0.8,
            				scale: 0.8,
            			},
            			qixing: {
            				name: xixiguagua.SS_wolongyance_qixing.name,
            				speed: 0.8,
            				scale: 0.8,
            			},
                    };
                    ...
                    // 私有方法
                    const playBagua = () => {
                        dcdAnim.loadSpine(WMWOLONGYANCE.bagua.name, "skel", () => {
                            state.baguaAn = dcdAnim.playSpine(WMWOLONGYANCE.bagua);
                        });
                    };
                
                    const createShitiImg = (left, top, type) => {
                        const className = type ? ".wlan-shiti-dui" : ".wlan-shiti-cuo";
                        const audioName = type ? "Skillerr" : "Skillok";
                        game.playAudio(`../extension/标记补充/audio/${audioName}.mp3`);
                        
                        const shitiImg = ui.create.div(className + " .wlan-shiti", document.body);
                        shitiImg.style.cssText += `top: ${top};left:${left};`;
                        state.shitiImgArr.push(shitiImg);
                    };
                
                    const playShiti = (x, y) => {
                        dcdAnim.loadSpine(WMWOLONGYANCE.shiti.name, "skel", () => {
                            if (dev) WMWOLONGYANCE.shiti.loop = true;
                            dcdAnim.playSpine(WMWOLONGYANCE.shiti, { x, y });
                        });
                    };
                
                    const playQixing = () => {
                        dcdAnim.loadSpine(WMWOLONGYANCE.qixing.name, "skel", () => {
                            WMWOLONGYANCE.qixing.action = "play" + state.num;
                            if (dev) WMWOLONGYANCE.qixing.loop = true;
                            state.qixingAn = dcdAnim.playSpine(WMWOLONGYANCE.qixing);
                        });
                    };
                
                    const end = () => {
                        state.wolongbg?.remove();
                        state.wolonganTitle?.remove();
                        state.shitiImgArr.forEach(item => item.remove());
                        state.qixingAn && dcdAnim.stopSpine(state.qixingAn);
                        state.baguaAn && dcdAnim.stopSpine(state.baguaAn);
                        if (!dev) game.resume();
                    };
                    ...
                    return {
                        init() {
                            state.wolongbg = ui.create.div(".wlan-bg", document.body);
                            state.wolonganTitle = ui.create.div(".wlan-title", document.body);
                            playBagua();
                            this.play();
                        },
                        ...
                        play() {
                            game.pause();
                            if (state.num > 1) playQixing();
                
                            state.anInfo.info.forEach((item, index) => {
                                const timeout = Array.isArray(state.anInfo.timeout) 
                                    ? state.anInfo.timeout[index] 
                                    : state.anInfo.timeout * index;
                
                                setTimeout(() => {
                                    createShitiImg(item.left, item.top, state.result[index]);
                                    playShiti(item.x, item.y);
                                    
                                    if (index === state.anInfo.info.length - 1) {
                                        setTimeout(() => !dev && end(), 2000);
                                    }
                                }, timeout);
                            });
                        },
        		...
        		WoLongIcon(links, player, show = false) {
                    const instance = {
                        links: links.map(item => item.split("_")[0]),
                        player,
                        show,
                        iconCon: null,
                        iconList: [],
                        ...
                        WMWOLONGYANCE: {
                            chenggong: {
                                name: xixiguagua.SS_junei_wolongyancechenggong.name,
                                speed: 0.8,
                                scale: 0.8,
                                loop: true
                            }
                        ...
                        createIcon() {
                            ...
                            this.links.forEach((item, index) => {
                                const iconName = this.hide() ? "wenhao" : item;
                                const icon = ui.create.div(".wlyc-icon", this.iconCon);
                                icon.style.cssText += `background-image:url(${lib.assetURL}extension/标记补充/image/wolongyance/paiju_jingce_icon_${iconName}.png);`;
                        ...
                        changeIcon(index, flag) {
                            const type = flag ? "dui" : "cuo";
                            this.iconList[index].style.cssText += `background-image:url(${lib.assetURL}extension/标记补充/image/wolongyance/paiju_jingce_icon_${type}.png);`;
                            
                            if (flag) {
                                dcdAnim.loadSpine(this.WMWOLONGYANCE.chenggong.name, "skel", () => {
                                    const iconan = dcdAnim.playSpine(this.WMWOLONGYANCE.chenggong, {
                        ...
                        /*clear() {
                            this.iconAnList.forEach(item => dcdAnim.stopSpine(item));
                            this.iconList.forEach(item => item.remove());
                            this.iconCon?.remove();
                            this.iconCon = null;
                        }*/
                        /* 修改 WoLongIcon 对象的 clear 方法 */
                        clear() {
                            // 停止所有骨骼动画
                            this.iconAnList.forEach(item => dcdAnim.stopSpine(item));
                            ...
                            const removeElement = (element) => {
                                return new Promise(resolve => {
                                    element.style.animation = 'popOut 0.3s ease forwards';
                            ...
                            // 逐个移除图标
                            Promise.all(this.iconList.map(icon => removeElement(icon)))
                                .then(() => {
                                    // 最后移除容器
                                    if (this.iconCon) {
                                        return removeElement(this.iconCon);
                                    }
                                });
        				...
        				mod: {
        					aiOrder(player, card, num) {
        						if (num > 0) {
        							...
        							if (player.hasSkill("friendzhugelianggongli") && lib.skill.friendgongli.isFriendOf(player, "friend_xushu") && storage[0].length === 0) return;
        			...
        			check: {
        				...
        				content() {
        					...
        					if (trigger.name === "useCard") {
        						...
        						if (get[storage[2]](trigger.card) === i || (player.hasSkill("friendzhugelianggongli") && lib.skill.friendgongli.isFriendOf(player, "friend_xushu") && storage[0].length === 0)) {
        						...
        						if(player.wolongicon) {
            						let resultList = storage[0];
                    				if (resultList.length) {
                    					player.wolongicon.changeIcon(resultList.length - 1, resultList[resultList.length - 1]);
                    				}
                				}
        					}
        					if (trigger.name !== "useCard" || storage[0].length === storage[3]) {
        					    if(lib.config.effect_friend_zhugeliang) {
        					        lib.skill.friendyance.WolongYanceEffect(storage).init();
        					    }
        						...
        						if (trueArr.length * 2 < storage[3]) {
        							if (trueArr.length !== 0) player.logSkill("friendyance");
        							if (player.hasCard(card => lib.filter.cardDiscardable(card, player), "he")) player.chooseToDiscard(1 + num, "he", true);
        							if(player.wolongicon) {
        							    player.wolongicon.clear();
        							}
        							event.goto(2);
        						} else {
        							player.logSkill("friendyance");
        							var choice = storage[2] == "color" ? Object.keys(lib.color).filter(c=>c!='none') : lib.inpile.map(name => get.type2(name)).unique();
        							player
        								.chooseControl(choice)
        								.set("ai", () => {
        									//return choice.remove("none").randomGet();
        									return choice.filter(c=>c!="none").randomGet();
        								})
        					...
        					if (result.control) {
        						...
        						while (gains.length < 1 + num) {
        							const card = get.cardPile2(card => {
        								...
        								return get[storage[2]](card) === result.control;
        							});
        	...
        	friendfangqiu: {
        		audio: 3,
        		limited: true,
        		trigger: { player: "friendyance_minigameAfter" },
        		check(event, player) {
        	...
        	friendgongli: {
        		...
        		isFriendOf(player, name) {
        			return player.getFriends(true).some(target => {
        				...
        				var getisplayernames = function(player, name) {
        	                var getnamelist = function(playerx) {
        		                let type;
        		                if (typeof playerx == "undefined" || ((type = typeof playerx), type != "object") || ((type = get.itemtype(playerx)), type != "player")) {
        			                throw new Error(`函数接受了一个不是Player的东西: ${type}: ${playerx}`);
        		                };
        		                var list = [];
        		                for (var prop of ["name", "name1", "name2"]) {
        		                    if (playerx[prop]) list.add(playerx[prop]);
        		                };
        		                return list;
        	                };
        		            return getnamelist(player).some(namex => namex.startsWith(name));
        	            };
        				return getisplayernames(target, name);
        			});
        		},
        	},
			//王经
        	...
        	mbjiejian: {
        		...
        		content: function() {
    				...
    				player.chooseCardTarget({
						...
						selectCard: [1, Infinity],
						prompt: event.used.length ? "是否继续分配手牌？" : get.prompt("mbjiejian"),
						...
						ai2: function (target) {
							...
							if (val <= 4) {
								if (event.used.includes(target)) return 0;
    				...
    				if (result.bool && result.targets.length) {
    					...
    					event.used.addArray(result.targets);
    				} else {
    				    event.goto(4);
    				}
    				'step 3'
        			...
        			event.cost_data=list;
        			event.targets=targets;
        			if(!list.length > 0) event.finish();
        			'step 5'
        			var list = event.cost_data;
        			game.loseAsync({
        					gain_list: list,
        					player: player,
        		...
        		subSkill: {
        			liuli: {
        				...
        				content: function() {
        					...
        					evt.triggeredTargets2.removeArray(trigger.targets);
        					evt.targets.removeArray(trigger.targets);
        			...
        			remove: {
        				...
        				content: function() {
        					...
        					if (target.hp >= num) player.draw(2);
        				},
        			},
        			mark: {
        				intro: {
				...
				subSkill:{
					sub:{
						...
						content:function(){
							...
							player.removeSkill('dclifeng_sub');
						}
					}
				}
			},
			...
			mbdanggu:{
				...
				content:function(){
					'step 0'
					if(window.doubleKuang) game.hasDoublePossble=true;
					var list=lib.skill.mbdanggu.changshi.map(i=>i[0]);
					...
					if(result.bool){
						...
						if(lib.skill.mbdanggu.isSingleShichangshi(player)){
							game.broadcastAll(function(player,first,chosen){
								...
								player.name2=chosen;
								if(window.doubleKuang) window.doubleKuang(player);
					...
					dying:{
						...
						content:function(){
							...
							if(result.control=='选项一'){
								...
								if(num>0){
									player.loseHp(num);
									trigger.player.changeHujia(num,null,true);
								}
							}
							else {
			...
			baiyi:{
				...
				content:function(){
					...
					if(lib.config.extension_十周年UI_enable&&lib.config.effect_simashi) {
                        ...
                        game.delay(2);
						targets.forEach(tar=>{
			 		        tar.createHighLight([[255,255,255],[255,255,0],[255,200,0]],7,{level:3}).style.transition='transform 4s ease-out, opacity 3.5s 0.5s linear';
			 		        setTimeout(function(){
			...
			shanli:{
				...
				content:function(){
					...
					target.addZhuSkill(result.control, event.name);
			...
			mbqianlong: {
		        ...
		        content: function() {
		            var num = 20;
		            if(player.hasZhuSkill('mbweitong')) num = 60;
		    ...
		    mbcmqingzheng: {
		        ...
		        content: function() {
		            ...
		            next.set('ai', button => {
		                var player = _status.event.player;
		                return 15 - player.getCards('h', {
		                    suit: button.link[2].slice(6)
		                }).map(i => get.value(i)).reduce((p, c) => p + c, 0);
		            });
		            next.set('custom', {
		                replace: {
		                ...
		                if (list.length) {
		                    player.chooseControl(list).set('dialog', dialog).set('ai', () => {
		                        ...
		                        return list.sort((a, b) => {
		                            return getv(target.getCards('h', {
		                                suit: b
		                            })) - getv(target.getCards('h', {
		                                suit: a
		                            }));
		                        })[0];
		                    })());
		    ...
		    mbcmfangzhu: {
		        ...
		        content: function() {
		            'step 0'
		            player.chooseControl(['技能失效', '无法用牌']).set('prompt', '选择令' + get.translation(target));
		            'step 1'
		            //放逐弱化
		            player.storage.mbcmfangzhu = target;
		            var whenname=player.addWhen({
    				    trigger: { player: "phaseUseAfter" },
    				    target: target,
    				    firstDo: false,
    				    priority: -10,
    				    content: function() {
    				        player.storage[_when.name]=true;
    				    },
    				});
    				player.addWhen({
    				    trigger: { player: "phaseUseAfter" },
    				    ...
    				    priority: 10,
    				    filter: function(event,player) {
    				        return (player.storage[_when.whenname]&&_when.target==player.storage.mbcmfangzhu)||_when.target!=player.storage.mbcmfangzhu;
    				    },
    				    content: function() {
    				        if(_when.target==player.storage.mbcmfangzhu) {
    				            player.storage.mbcmfangzhu=undefined;
    				        }
    				    },
    				});
		            if (result.control == '技能失效') {
		                target.addTempSkill('mbcmfangzhu_baiban', {
		                    player: 'phaseEnd'
		                });
		                event.finish();
		            } else {
		                target.addTempSkill('mbcmfangzhu_jin', {
		                    player: 'phaseEnd'
		                });
		    ...
		    mbjuejin: {
		        ...
		        content: function() {
		            "step 0"
		            var list=[];
                    /*if(player.name&&get.character(player.name)[3].includes('mbjuejin')) list.add(player.name);
                    if(player.name1&&get.character(player.name1)[3].includes('mbjuejin')) list.add(player.name1);
                    if(player.name2&&get.character(player.name2)[3].includes('mbjuejin')) list.add(player.name2);
		            ...
		            game.countPlayer(c => c.update());
		            "step 3"
		            //给玩家洗牌，不然手牌会断断续续
		            lib.skill.mbjuejin.washCard();
		    ...
		    mbcmxscw: {
		        mark: true,
		        intro: {
		            content: "<li>向死存魏：当有牌进入弃牌堆后，系统将这些牌中的【闪】、【桃】和【酒】移出游戏。",
		            markcount: () => null,
		        },
		        trigger: {
		    ...
		    mbweitong: {
		        ...
		        filter: function(event, player) {
		            return player.hasSkill('mbqianlong') && (event.name != 'phase' || game.phaseNumber == 0) && game.hasPlayer(current => {
		    ...
		    potzhanlie: {
        		...
        		content() {
        			...
        			if(num>0) {
    					get.info("potzhanlie").changeDianchi(player,'max');
    					get.info("potzhanlie").changeDianchi(player,'max',num);
    					get.info("potzhanlie").dianchiUpdate(player);
					}
        		},
        		get limit() {
        			return 6;
        		},
        		shaHistory: function(player,add) {
        		    if(typeof player.storage.potzhanlie_history!='number') {
        		        player.storage.potzhanlie_history=0;
        		        player.addWhen({
        				    content: function() {
        				        player.storage.potzhanlie_history=undefined;
        				    },
        				});
        		    }
        		    if(add) player.storage.potzhanlie_history+=add;
        		    return player.storage.potzhanlie_history;
        		},
        		changeDianchi: function(player,type,change) {
        		    var sum=get.info("potzhanlie").limit;
        		    if(!player.storage.potzhanlie_lie) {
					    player.storage.potzhanlie_lie=0;
					}
					if(!player.storage.potzhanlie_addMark) {
					    player.storage.potzhanlie_addMark=0;
					}
					if(!type||!['max','num'].contains(type)) return false;
					var stg=type=='max'?'potzhanlie_addMark':'potzhanlie_lie';
					if(!change) {
					    player.storage[stg]=0;
					}else {
					    player.storage[stg]+=change;
					    if(type=='num'&&player.storage[stg]>sum) {
					        player.storage[stg]=sum;
					    }
					}
        		},
        		dianchiUpdate: function(player) {
                    var sum = get.info("potzhanlie").limit;
                    var num = player.countMark("potzhanlie_lie");
                    var can = Math.max(
                        player.countMark("potzhanlie_addMark") - 
                        get.info("potzhanlie").shaHistory(player),
                        0
                    );
                    
                    // 外层统一设置字重和文字阴影（通过双重阴影加粗）
                    var text = "<span style='"
                         + "font-weight: 900 !important;"
                         + "text-shadow: 0.8px 0 currentColor, 1.6px 0 currentColor;"  // 基础阴影
                         + "letter-spacing: 0.1em;"  // 新增字间距
                         + "filter: drop-shadow(0 0 1.5px black) drop-shadow(0 0 1.5px black);"
                         + "'>";
                    
                    // 第一段（高亮部分）
                    text += "<span style='opacity: 1; color: rgb(40, 200, 110);'>";
                    for (var i = 0; i < Math.min(sum, num); i++) text += '|';
                    text += "</span>";
                    
                    // 第二段（半透明可用部分）
                    text += "<span style='opacity: 0.6; color: rgb(30, 120, 70);'>";
                    for (; i < Math.min(sum, num + can); i++) text += '|';
                    text += "</span>";
                    
                    // 第三段（灰色不可用部分）
                    text += "<span style='opacity: 0.6; color: rgb(155, 155, 155);'>";
                    for (; i < sum; i++) text += '|';
                    text += "</span>";
                    
                    text += "</span>"; // 结束外层样式
                    
                    var str = "<span style='font-weight: 600; color: rgb(210, 210, 210);'>[" + text + "]</span>";
                    player.unmarkSkill("potzhanlie_mark");
                    player.storage["potzhanlie_mark"] = '';
                    player.addMark("potzhanlie_mark", str);
                },
        		onremove: function(player,skill) {
        		    player.unmarkSkill("potzhanlie_mark");
        		},
        		...
        		subSkill: {
        			mark: {
        				...
        				intro: {
        					...
        					content:function(storage,player){
        					    var sum=get.info("potzhanlie").limit;
                    		    var max=player.countMark("potzhanlie_addMark");
                    		    var num=player.countMark("potzhanlie_lie");
                    		    var can=Math.max(
        							player.countMark("potzhanlie_addMark") -
        								get.info("potzhanlie").shaHistory(player),
                		        ...
                		        return "当前拥有["+num+"/6]枚“烈”标记<li>本回合还可获得"+can+"枚";
        					},
        				},
        			},
        			addMark: {
        				...
        				filter(event, player) {
							...
							//player.storage.potzhanlie_history=history;
        					return Math.min(
        				...
        				content() {
        					...
        					var num=Math.min(trigger.getd().filter(i => i.name === "sha").length,player.countMark("potzhanlie_addMark"));
        					get.info("potzhanlie").shaHistory(player,num);
        					get.info("potzhanlie").changeDianchi(player,'num',num);
        					get.info("potzhanlie").dianchiUpdate(player);
        				},
        			...
        			lie: {
        				trigger: { player: "phaseUseEnd" },
        				filter: (event, player) => player.hasUseTarget({ name: "sha" }, false),
        				direct: true,
        				content() {
        					const str = player.hasMark("potzhanlie_lie") ? "移去所有“烈”，" : "";
        					player.chooseUseTarget("###" + get.prompt("potzhanlie") + '###' + str + "视为使用一张无次数限制的【杀】", { name: "sha" }, false).set("oncard", () => {
        						var num = player.countMark("potzhanlie_lie");
        						player.addTempSkill("potzhanlie_buff");
            					get.info("potzhanlie").changeDianchi(player,'num');
            					get.info("potzhanlie").dianchiUpdate(player);
        						//player.clearMark("potzhanlie_lie");
        						//_status.event.set("potzhanlie", Math.floor(num / 3));
        						_status.event.potzhanlie=Math.floor(num / 2);
        					}).logSkill = "potzhanlie";
        				},
        				marktext: "烈",
        				intro: {
        					...
        					player
        						...
        						.set("filterButton", function(button){
                                    ...
                                    if(ui.selected.buttons&&ui.selected.buttons.contains(button)) {
                                        ...
                                        button.style.setProperty('color', 'rgb(0, 0, 0)', 'important');
                                    }
                                    return true;
        						})
        							...
        							switch (choice) {
        								case "目标+1":
        									player.addWhen({
                            				    trigger: { player: "useCard1" },
                            				    card: trigger.card,
                            				    target: trigger.targets,
                            				    evt: trigger,
                            				    priority: -Infinity,
                            				    filter: function(event, player) {
                            				        return event==_when.evt;
                            				    },
                            				    content: function() {
                            				        'STEP 0'
                            				        player
        												.chooseTarget("是否为" + get.translation(_when.card) + "增加一个目标？", (card, player, target) => {
    												...
    												if (result?.bool && result.targets?.length) {
        												...
        												player.line(target, _when.evt.card.nature);
        												_when.evt.targets.add(target);
        												game.log(target, "成为了", _when.evt.card, "的额外目标");
        											}
                            				    },
                            				});
        									/*player
        			...
        			guanshi: {
        				...
        				content: function() {
        					"step 0"
        					trigger.target.chooseToDiscard("战烈：弃置一张牌，否则不可响应" + get.translation(trigger.card)).set("ai", card => {
        	...
        	pothanzhan: {
        		...
        		content: function() {
        			...
        			for (const drawer of [player, target]) {
        				...
        				if (num > 0) drawer.draw(Math.min(num, 3));
        			}
        			const juedou = { name: "juedou" };
        			if (player.canUse(juedou, target)) player.useCard(juedou, target, false);
        		},
        		ai: {
        			order(item, player) {
        				...
        				return {
        					...
        					content: function() {
        						...
        						if (get.info(event.name).item === "recover") {
        							...
        							player.changeAvatarTo("pot_taishici", "pot_taishici_shadow1");
        							player.recover(2);
        							event.finish();
        						}
        						"step 1"
    							...
    							if (result?.bool && result.links?.length) {
    								...
    								if (changeList.length > 1 && changeList[0] === changeList[1]) {
    									switch (changeList[0]) {
    										case "hp":
    											player.changeAvatarTo("pot_taishici", "pot_taishici_shadow2");
    											break;
    										case "damagedHp":
    											player.changeAvatarTo("pot_taishici", "pot_taishici_shadow3");
    											break;
    										case "countplayer":
    											player.changeAvatarTo("pot_taishici", "pot_taishici_shadow4");
    									}
    								}
    							}
        					},
        	...
        	potzhenfeng:{
        		...
        		logAudio: index => (typeof index === "number" ? "potzhenfeng" + index + ".mp3" : 2),
        		filter:function(event,player) {
        		    if(player.storage.potzhenfeng) return false;
        		    return (player.isDamaged()||["pothanzhan", "potzhanlie"].some(skill => player.hasSkill(skill, null, null, false)));
        		},
        		direct:true,
        		content:function() {
        		    ...
        		    var list=[];
        		    var listValue={};
        		    player.storage.potzhenfeng_ai=true;
        		    player.addWhen({
        		        content:function(){
        		            player.storage.potzhenfeng_ai=false;
        		        },
        		    });
        		    if(player.isDamaged()) list.push("回复2点体力");
        		    if(["pothanzhan", "potzhanlie"].some(skill => player.hasSkill(skill, null, null, false))) list.push("修改技能");
        		    list.push("取消");
        		    list.forEach(s=>{
        		        if(s=="取消") {
        		            listValue[s]=-1;
        		        }else if(s=="回复2点体力") {
        		            listValue[s]=(player.getHp() + player.countCards("h", { name: "tao" }) < 2);
        		        }else if(s=="修改技能") {
        		            var val=0.1;
        		            var numbers = [player.getHp(), player.getDamagedHp(), game.countPlayer()];
        					if (numbers.some(c => c > player.getAttackRange())) val=Math.max(...numbers) * 2;
        		            listValue[s]=val;
        		        }
        		    });
        		    var cho="取消";
        		    var vals=-1;
        		    for(var s in listValue) {
        		        if(listValue[s]<=vals) continue;
        		        chos=s;
        		        vals=listValue[s];
        		    }
        		    player.chooseControl(list,function(){
        				return cho;
        		    }).set("prompt",get.prompt2("potzhenfeng"));
        		    "step 1"
					...
					"step 3"
					if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_taishici) {
						decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
						decadeUI.animation.playSpine({ name: "SS_taishici_jineng", action: "play2" }, { scale: 0.9 });
						//game.delay(5);
						//decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
					}
					player.changeAvatarTo("pot_taishici", "pot_taishici_shadow1");
					...
					"step 4"
					event.dialog = [];
					event.skills = ["pothanzhan", "potzhanlie"].filter(skill => player.hasSkill(skill, null, null, false));
					event.list = [
							["hp", "当前体力值"],
							["damagedHp", "当前已损失体力值"],
							["countplayer", "场上存活角色数"],
						];
					event.dialog.push("振锋：修改" + event.skills.map(skill => "〖" + get.translation(skill) + "〗").join("和") + "描述中的“X”为...");
					for (const skill of event.skills) {
						event.dialog.push('<div class="text center">' + get.translation(skill) + "</div>");
						event.dialog.push([event.list.map(item => [item[0] + "|" + skill, item[1]]), "tdnodes"]);
					}
					player
						.chooseButton(event.dialog, [1, Math.min(2, event.skills.length)], true)
						.set("filterButton", button => {
							button.style.backgroundImage="url('"+lib.assetURL+"/image/scroll.png')";
							button.style.setProperty('width', '180px', 'important');
                            button.style.setProperty('height', '40px', 'important');
                            ...
                            button.style.setProperty('line-height', '40px', 'important');
                            button.style.setProperty('text-shadow', 'none', 'important');
                            button.style.setProperty('margin-top', '-5px', 'important');
                            button.style.setProperty('margin-botton', '-5px', 'important');
                            button.style.setProperty('border-radius', '3px', 'important');
                            if(ui.selected.buttons&&ui.selected.buttons.contains(button)) {
                                button.style.setProperty('color', 'rgb(255, 255, 255)', 'important');
                            }else {
					...
					if (result?.bool && result.links?.length) {
						...
						for (const link of result.links) {
							...
							player.storage[skill] = change;
							player.popup(skill);
							game.log(player, "修改", "#g【" + get.translation(skill) + "】", "的", "#yX", "为", "#g" + event.list.find(item => item[0] === change)[1]);
						}
														if (changeList[0].length > 0 ) {
							switch (changeList[0]) {
								case "hp":
								    if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_taishici) {
									    decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									    decadeUI.animation.playSpine({ name: "SS_taishici_jineng", action: "play4" }, { scale: 0.9 });
            							//game.delay(5);
            							//decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									}
									player.changeAvatarTo("pot_taishici", "pot_taishici_shadow3");
								...
								case "damagedHp":
								    if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_taishici) {
									    decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									    decadeUI.animation.playSpine({ name: "SS_taishici_jineng", action: "play3" }, { scale: 0.9 });
            							//game.delay(5);
            							//decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									}
									player.changeAvatarTo("pot_taishici", "pot_taishici_shadow2");
								...
								case "countplayer":
								    if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_taishici) {
									    decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									    decadeUI.animation.playSpine({ name: "SS_taishici_jineng", action: "play5" }, { scale: 0.9 });
            							//game.delay(5);
            							//decadeUI.animation.playSpine({ name: "huanpifu", action: "huanpifu_yellow" }, { scale: 0.75, x: [0, 0.51], y: [0, 0.52], parent: player });
									}
									player.changeAvatarTo("pot_taishici", "pot_taishici_shadow4");
        		...
        		ai: {
        			...
        			result: {
        				player(player) {
        					if (player.storage.potzhenfeng_ai) return 0;
        					if ([player.getHp(), player.getDamagedHp(), game.countPlayer()].some(c => c > player.getAttackRange())) return 10;
        					return get.recoverEffect(player, player, player);
        				},
        			},
            ...
            potdaozhuan: {
				...
				prompt: function (event) {
					...
					let num = list.length;
					if (num > 0) return "你可以弃置你与当前回合角色共计" + get.cnNumber(num) + "张牌并视为使用一张本轮未以此法使用过的一张基本牌";
					return "你可以视为使用一张本轮未以此法使用过的一张基本牌";
				},
				filter: function (event, player) {
					...
					if (_status.currentPhase && _status.currentPhase.isIn() && _status.currentPhase !== player) num -= _status.currentPhase.countCards("he");
					if (num > 0 || player.hasSkill("potdaozhuan_block")) return false;
					for (var i of lib.inpile) {
						var type = get.type2(i);
						if ((type == 'basic') && event.filterCard({ name: i }, player, event) && !player.getStorage("potdaozhuan_used").includes(i)) return true;
					}
					return false;
				},
				chooseButton: {
					dialog: function (event, player) {
						...
						for (var i = 0; i < lib.inpile.length; i++) {
							var name = lib.inpile[i];
							if (!player.getStorage("potdaozhuan_used").includes(name)) {
								if (name == 'sha') {
						...
						return ui.create.dialog("道转", [list, "vcard"]);
					},
					filter: function (button, player) {
					...
					prompt: function (links, player) {
						...
						if (num > 0) {
							prompt += "将你";
							if (_status.currentPhase && _status.currentPhase.isIn() && _status.currentPhase !== player) prompt += "与" + get.translation(_status.currentPhase);
					...
					backup: function (links) {
						return {
							...
							precontent: function () {
								...
								event.num = list.length;
								if (event.num === 0) event._result = { bool: true };
								else {
									var goon = _status.currentPhase && _status.currentPhase.isIn() && _status.currentPhase !== player;
									let prompt = "将你";
									if (goon) prompt += "与" + get.translation(_status.currentPhase);
									prompt += "的共计" + get.cnNumber(event.num) + "张牌置入弃牌堆";
									...
									player
										.chooseButton(dialog, event.num, true)
										.set("ai", button => {
											const player = _status.event.player,
									...
									if (result.links && result.links.length) {
										...
										if (owners.length > 1) {
											...
											game
												...
												}).setContent(get.info("potdaozhuan").loseToDiscardpileMultiple);
										} else {
											owners[0].loseToDiscardpile(result.links);
											if (owners[0] === target) {
												player.addTempSkill("potdaozhuan_block", "roundStart");
												player.shixiaoSkill("potdaozhuan");
											}
										}
									}
									return;
				...
				hiddenCard: function (player, name) {
					if (player.hasSkill("potdaozhuan_block")) return false;
				...
				ai: {
					...
					order: function (item, player) {
						if (player && _status.event.type === "phase") {
							...
							for (var i of lib.inpile) {
								var type = get.type2(i);
								if ((type == 'basic') && event.filterCard({ name: i }, player, event) && !player.getStorage("potdaozhuan_used").includes(i)) names.add[i];
							}
							names.forEach(card => {
				...
				subSkill: {
					block: {
						charlotte: true,
						onremove: function (player) {
							player.unmarkSkill("potdaozhuan_block");
							player.unshixiaoSkill("potdaozhuan");
						},
						marktext: "道转 失效",
						mark: true,
						intro: { content: "本轮道转失效" },
					},
					backup: {},
					used: {
						charlotte: true,
            ...
            potfuji: {
                ...
                init:function(player,skill) {
                    game.createCss(`@keyframes potfuji_loop {
				        0% {
				            opacity: 1;
				        }
				        50% {
                ...
                usable: 1,
                prompt: (event) => "你可以展示场上的手牌并分配给等量的角色",
                chooseButton: {
                    dialog: function (event, player) {
                    ...
                    select: () => [1, game.countPlayer(target => target !== _status.event.player)],
                    check: function (button) {
                        const player = _status.event.player,
                            source = get.owner(button.link);
                        return get.value(button.link, get.owner(source)) * Math.sign(-get.attitude(player, source));
                    ...
                    prompt: function (links) {
                        return "将" + get.translation(links) + "交给等量角色，获得杀/闪的角色使用同名牌伤害+1/摸一张牌，若你手牌最少，你摸两张牌并视为拥有所有效果。";
                    },
                    backup: function (links) {
                        return {
                            giveCards: links,
                            ...
                            targetprompt() {
                                ...
                                return ["获得", get.translation(links[ui.selected.targets.length - 1]).replace("【","·").replace("】","")].join("<br>");					
                            },			
                            multiline: true,
                            multitarget: true,
                            complexSelect: true,
                            content: function () {
                                "step 0"
                                var links = get.info("potfuji_backup").giveCards;
                                let map = new Map(),
                                    lose_list = [];
                                ...
                                game.delayx();
                                var gain_list = links.map((link, i) => [targets[i], [link]]);
                                game
                                    .loseAsync({
                                        gain_list: gain_list,
                                        giver: player,
                                    ...
                                    .setContent("gaincardMultiple");
                                if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_yuji!="none") {
				                    if(lib.config.effect_pot_yuji=='anim') game.playAnimation('extension/标记补充/animation/potyuji_effect.mp4');
                                    decadeUI.animation.playSpine({ name: "SS_pve_YJChuChang", action: "play" }, { scale: 0.8, x: [0, 0.52], y: [0, 0.5], parent: player });
    						        decadeUI.animation.playSpine({ name: "SS_pve_YJChuChangKuang", action: "play" }, { scale: 0.93 });
    						        setTimeout(function(){
                                        player.changeAvatarTo('pot_yuji','pot_yuji_shadow');
                                        setTimeout(function(){
        						            //player.pot_yuji_effect = decadeUI.animation.playSpine({ name: "SS_pve_WJLiuShuigx", loop: true }, { scale: 0.76, x: [0, 0.52], y: [0, 0.56], parent: player });
        						            player.createHighLight([[180,255,255],[0,220,255],[0,170,230]],6,{level:8}).style.animation = 'potfuji_loop 5s infinite ease';
    						            },300);
    						        },1600);
						        }
                                player.addWhen({
                                    ...
                                    content:function(){
                                        if(lib.config.extension_十周年UI_enable&&lib.config.effect_pot_yuji) {
                                            decadeUI.animation.playSpine({ name: "SS_pve_YJChuChang", action: "play" }, { scale: 0.8, x: [0, 0.52], y: [0, 0.5], parent: player });
            						        decadeUI.animation.playSpine({ name: "SS_pve_YJChuChangKuang", action: "play" }, { scale: 0.93 });
            						        setTimeout(function(){
                                                player.changeAvatarTo('pot_yuji','pot_yuji_shadow',false);
                                                setTimeout(function(){
                						            /*if(player.pot_yuji_effect) {
                						                decadeUI.animation.stopSpine(player.pot_yuji_effect);
                						                player.pot_yuji_effect=undefined;
                						            }*/
                						            player.createHighLight([],0,{level:8,opacity:0}).style.animation='none';
            						            },300);
            						        },1600);
        						        }
                                    },
                                });
                                /*dcdAnim.loadSpine(xixiguagua.SS_pve_YJChuChang.name, "skel", function () {
                                    dcdAnim.playSpine(xixiguagua.SS_pve_YJChuChang, { speed: 1, scale: 0.8, parent: player });
                                });
                                dcdAnim.loadSpine(xixiguagua.SS_pve_WJLiuShuigx.name, "skel", function () {
                                    dcdAnim.playSpine(xixiguagua.SS_pve_WJLiuShuigx, { speed: 1, scale: 0.8, parent: player, loop: true });
                                });*/
                                for (var [target, [link]] of gain_list) {
                                    var name = get.name(link, false);
                                    if (["sha", "shan"].includes(name)) {
                                        player.addTempSkill("potfuji_clear", { player: "phaseBegin" });
                                        target.addSkill("potfuji_" + name);
                                    }
                                }
                                "step 1"
                                if (player.isMinHandcard()) {
                                    player.draw(2);
                                    player.addTempSkill("potfuji_clear", { player: "phaseBegin" });
                                    var list = ["potfuji_sha", "potfuji_shan"];
                ...
                subSkill: {
                    ...
                    clear: {
                        charlotte: true,
                        onremove: function (player) {
                            game.countPlayer(current => current.removeSkill("potfuji_sha"));
                            game.countPlayer(current => current.removeSkill("potfuji_shan"));
                        },
                    },
                    sha: {
                        charlotte: true,
        	...
        	mbzengou: {
        		...
        		content() {
        			'step 0'
    				if(lib.config.effect_mb_qinghegongzhu) game.playAnimation('extension/标记补充/animation/qinghegongzhu_zengou.mp4');
        			game.delay();
        			'step 1'
        			player.viewHandcards(target);
        			'step 2'
        			event.names = lib.inpile.filter(i => get.type(i) === "basic");
        			event.allNames = player
        				.getCards("h", i => target.hasCard({ name: get.name(i) }, "h"))
        				.map(i => get.name(i));
        			event.goon = get.inpileVCardList(info => event.names.includes(info[2]) && !target.hasCard({ name: info[2] }, "h")).some(info => player.hasUseTarget({ name: info[2], nature: info[3] }, false, false));
        			'step 3'
        			if (!event.goon && !event.allNames.length) event.finish();
        			'step 4'
        			if (!event.goon) event._result = {index: 1};
        			else if (!event.allNames.length) event._result = {index: 0};
        			else player.chooseControl()
        					.set("choiceList", [
        						"视为使用两张" +
        							event.names
        								...
        								.join("、") +
        							(event.names.filter(i => !target.hasCard({ name: i }, "h")).length > 1 ? "中的牌" : "") +
        							"（无距离和次数限制）",
        						"将你与其手牌中的" + event.allNames.map(i => "【" + get.translation(i) + "】").join("、") + "替换为牌堆中等量的【杀】且这些牌不计入各自手牌上限直到各自结束阶段",
        					])
        					.set("ai", () => {
        						const list = get.inpileVCardList(info => event.names.includes(info[2]) && !target.hasCard({ name: info[2] }, "h")).filter(info => player.hasUseTarget({ name: info[2], nature: info[3] }, false, false));
        						return Math.max(...list.map(info => player.getUseValue({ name: info[2], nature: info[3] }, false))) >
        							(() => {
        								let sum = 0;
        								sum += target.getCards("h", { name: event.allNames }).reduce((num, card) => num + get.value(card, target), 0);
        								sum -= player.getCards("h", { name: event.allNames }).reduce((num, card) => num + get.value(card, player), 0);
        								return sum;
        							})() *
    			    ...
    			    'step 6'
    			    if(event.i >= 2) event.goto(11);
    			    'step 7'
    			    event.i++;
					let list = get.inpileVCardList(info => event.names.includes(info[2]) && !target.hasCard({ name: info[2] }, "h")).filter(info => player.hasUseTarget({ name: info[2], nature: info[3] }, false, false));
					if (!list.length) {
					    event.goto(6);
				    }else {
    					if(list.length > 1) {
    					    player.chooseButton([get.translation(event.name) + "：请选择你要视为使用的基本牌", [list, "vcard"]], true)
								.set("ai", button => get.player().getUseValue({ name: button.link[2], nature: button.link[3] }, false, false));
    					}else {
    					    event._result = {
    					        links: list,
    					        bool: true,
    			    ...
    			    'step 8'
    			    if(result.bool && result.links) {
    			        player.chooseUseTarget({ name: result.links[0][2], nature: result.links[0][3] }, true, false, "nodistance");
    			    }
    			    event.goto(6);
    				'step 9'
    				event.cards = [player.getCards("h", { name: event.allNames }), target.getCards("h", { name: event.allNames })];
    				game.loseAsync({
    						lose_list: [
    							[player, event.cards[0]],
    							[target, event.cards[1]],
    						],
    					}).setContent(get.info(event.name).loseToDiscardpileMultiple);
					'step 10'
    				let gains = [[], []];
    				for (let i = 0; i < event.cards.length; i++) {
    					while (gains[i].length < event.cards[i].length) {
    						const card = get.cardPile2(card => {
    				...
    				if (gains.flat().length) {
    					...
    					} else player.gain(gains[0], "gain2");
    				}
        			'step 11'
        			if (event.names.length) {
        				if(event.names.length > 1) {
        					player.chooseControl(event.names)
								.set("ai", () => {
									if (get.attitude(player, target) < 0) {
										const cards = target.getCards("h", card => get.type(card) === "basic" && target.hasUseTarget(card));
										const names = cards.map(card => get.name(card));
										if (names.includes("sha") && event.names.includes("sha")) return "sha";
										if (names.includes("tao") && event.names.includes("tao")) return "tao";
									}
									return event.names.randomGet();
								})
								.set("prompt", "请选择令" + get.translation(target) + "获得的“诬”标记名称");
						}else {
        					result.control = event.names[0];
    					}
					}else {
					    event.finish();
					}
    				...
    				if (result.control) {
    					...
    					target.storage["mbzengou_debuff"][result.control] = 1 + (target.storage["mbzengou_debuff"][result.control] || 0);
        	...
        	mbfeili: {
        		...
        		content() {
        			...
        			event.controls = ["弃牌", "移标记", "cancel2"].filter(item => {
        						if (item === "cancel2") return true;
        						return (item === "弃牌" && goon1) || (item === "移标记" && goon2);
        					});
        			player.chooseControl(event.controls)
        				.set("choiceList", [
        				    `<span ${goon1?"":"style='color: rgb(180, 180, 180)'"}>弃置两张牌并防止此伤害</span>`, 
        				    `<span ${goon2?"":"style='color: rgb(180, 180, 180)'"}>移去${str}的“诬”标记并防止此伤害，然后你摸两张牌，本局游戏你不能再对其发动〖谮构〗</span>`
    				    ])
        				.set("ai", () => {
        					const { player, controls } = event;
        			...
        			switch (result.control) {
        				case "弃牌":
        					player.chooseToDiscard("弃置两张牌并防止此伤害", "he", 2, true).set("chooseonly", true);
        					break;
        				case "移标记":
        					result.bool = true;
        			...
        			if(!result.bool) {
        			    ...
        			    player.logSkill('mbfeili', trigger.source);
        			}
        			'step 3'
    				if(lib.config.effect_mb_qinghegongzhu) {
    				    game.playAnimation('extension/标记补充/animation/qinghegongzhu_feili.mp4');
    				    game.delay();
    				}
        			trigger.cancel();
		...
		dynamicTranslate:{
			...
			pothanzhan:function(player){
			    var effect=function(stg){
			        var str="各自体力上限";
			        if(stg=='hp') str="各自当前体力值";
			        if(stg=='damagedHp') str="各自当前已损失体力值";
			        if(stg=='countplayer') str="场上存活角色数";
			        return str;
			    }
			    return "出牌阶段限一次，你可以选择一名其他角色，你与其将手牌数摸至X张（X为"+effect(player.storage.pothanzhan)+"且至多摸三张），然后你视为对其使用一张【决斗】。";
			},
			potzhanlie:function(player){
			    var effect=function(stg){
			        var str="你的攻击范围";
			        if(stg=='hp') str="你当前的体力值";
			        if(stg=='damagedHp') str="你的已损失体力值";
			        if(stg=='countplayer') str="场上存活角色数";
			        return str;
			    }
			    return "①一名角色的回合开始时，你记录X（X为"+effect(player.storage.potzhanlie)+"），本回合中的前X张【杀】进入弃牌堆后，你获得等量“烈”标记（你至多拥有6个“烈”标记）。②出牌阶段结束时，你可移除全部”烈”标记（没有标记也可发动），视为使用一张无次数限制的【杀】并选择以下选项中的至多Y项（Y为你本次移除的标记数/2，向下取整）：1.令此【杀】可以额外指定一个目标；2.令此【杀】基础伤害值+1；3.令此【杀】需额外弃置一张牌方可响应；4.此【杀】结算完毕后，你摸两张牌。";
	        },
	        potkuanggu:function(player){
	            if(!player.getStorage('potkuanggu', 0)) {
                	return "你对距离1以内的一名角色造成伤害后，可以选择一项：1.回复1点体力；2.摸一张牌。";
        	    }else {
            	    return "你对距离1以内的一名角色造成伤害后，可以选择一项：1.回复1点体力；2.摸一张牌；3.背水，弃置一张牌并令你此阶段使用【杀】的次数+1。";
            	}
	        },
		},
		perfectPair:{
		...
		characterReplace:{
			...
			pot_weiyan:['pot_weiyan_achieve','pot_weiyan_fail'],
		},
		translate:{
			liuzan:'手杀留赞',
			...
			qiaosi:'巧思',
			qiaosi_info:'出牌阶段限一次，你可以表演「水转百戏图」并根据表演结果获得相应的牌。然后，你选择一项：1.弃置X张牌。2.将X张牌交给一名其他角色。（X为你以此法得到的牌数）',
			qiaosi_map:'水转百戏图',
			qiaosi_map_info:'<br><li>王：锦囊牌*2<br><li>商：装备牌/【杀】/【酒】*1<br><li>工：【杀】/【酒】*1<br><li>农：【闪】/【桃】*1<br><li>士：锦囊牌/【闪】/【桃】*1<br><li>将：装备牌*2',
			...
			shanli:'擅立',
			shanli_info:'觉醒技，准备阶段，若你已发动过〖败移〗且对至少两名角色发动过〖景略〗，则你减1点体力上限并选择一名角色。系统随机选择三个主公技，然后你选择其中一个技能，令其获得之。其将交互表情中的【拖鞋】和【酒杯】替换为【枷锁】和【玉玺】。',
			...
			yj_yuanshu:'星袁术',
			dccanxi:'残玺',
			dccanxi_info:'锁定技，游戏开始时，你获得场上各势力的“玺角”标记。每轮开始时，你选择一个“玺角”并选择一个效果生效直到下轮开始。1.妄生：与生效“玺角”势力相同的角色每回合首次造成的伤害+1；计算与其他角色的距离-1。2.向死：与生效“玺角”势力相同的其他角色每回合首次回复体力后，失去1点体力；每回合对你使用的第一张牌无效。',
			dcpizhi:'圮秩',
			dcpizhi_info:'锁定技，结束阶段，你摸X张牌；有角色死亡时，若其势力与生效“玺角”的势力相同，失去该“玺角”，然后摸X张牌（x为你失去的“玺角”数）。',
			dczhonggu:'冢骨',
			...
			mb_caomao_ab:'曹髦',
			mb_epic_caomao:'手杀曹髦',
			mb_epic_caomao_ab:'曹髦',
			mbqianlong:'潜龙',
			mbqianlong_info:'持恒技，游戏开始时，你获得20点道心值（你至多拥有99点道心值）。当你得到牌后你获得5点道心值；当你受到一点伤害后，你获得10点道心值；当你造成1点伤害后，你获得15点道心值，你根据你的道心值数量视为拥有以下技能：25点〖清正〗，50点〖酒诗〗，75点〖放逐〗，99点〖决进〗。',
			mbcmqingzheng:'清正',
			...
			mbcmfangzhu:'放逐',
			mbcmfangzhu_info:'持恒技。出牌阶段限一次。你可以选择一项令一名其他角色执行（不能选择上个出牌阶段选择的目标）：⒈令其不能使用手牌中的非锦囊牌直到其回合结束；⒉令其所有技能失效直到其回合结束。',
			mbjuejin:'决进',
			mbjuejin_info:'持恒技，限定技，出牌阶段，你可以令所有角色依次将体力回复或失去至1并获得X点护甲（X为一名角色以此法变化的体力值，你以此法获得的护甲值+2），然后你将场上所有【闪】、【桃】、【酒】移出游戏，并增加“向死存魏”光环效果：当有牌进入弃牌堆后，将这些牌中的【闪】、【桃】、【酒】移出游戏。',
			mbcmxscw:'向死存魏',
			mbweitong:'卫统',
			/*mbweitong_info:'主公技，持恒技，游戏开始时，你获得20X点道心值（X为场上其他魏势力角色数）。',*/
			mbweitong_info:'主公技，持恒技，游戏开始时，若场上有其他魏势力角色且你拥有〖潜龙〗，则你因其于游戏开始时获得的道心值修改为60。',
			mobile_dragon:'手杀异构·龙血玄黄',
	        ...
	        pot_yuji: "势于吉",
        	potdaozhuan: "道转",
        	potdaozhuan_backup: "道转",
        	pre_potdaozhuan_backup: "道转",
        	...
        	pot_weiyan: "势魏延",
        	pot_weiyan_achieve: "势魏延",
        	pot_weiyan_achieve_prefix: "势",
        	pot_weiyan_fail: "势魏延",
        	pot_weiyan_fail_prefix: "势",
        	potzhongao: "忠傲",
			...
			dagongche_attack_info: '大攻车·进击：武器牌，攻击范围9，2耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。当你对一名角色造成伤害时，你可-1耐久度令此伤害+x(x为当前轮数，至多为3)。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。',
			dagongche_defense: '大攻车',
			dagongche_defense_skill: '大攻车守御',
			dagongche_defense_info: '大攻车·守御：武器牌，攻击范围9，4耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。你受到伤害时，扣除等量的耐久度(不足则全扣)，然后减少等于扣除耐久度的伤害值。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。',
			dagongche_demo: '大攻车',
			dagongche_demo_info: '大攻车·进击：<li>武器牌，攻击范围9，2耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。当你对一名角色造成伤害时，你可-1耐久度令此伤害+X (X为当前轮数，至多为3)。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。<br><br>大攻车·守御：<li>武器牌，攻击范围9，4耐久度。此牌进入装备区时，弃置你装备区的其他牌。若此牌在你的装备区，当其他装备牌进入装备区时，改为置入弃牌堆。你受到伤害时，扣除等量的耐久度(不足则全扣)，然后减少等于扣除耐久度的伤害值。当此牌非因渠冲而移出装备区时，防止之，然后-1耐久度。当耐久度减至0时，销毁此牌。',
