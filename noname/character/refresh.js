...
game.import('character',function(lib,game,ui,get,ai,_status){
	return {
		...
		characterTitle:{
    		...
    		re_liubei: '#y汉昭烈帝',
    		re_diaochan: '#y千舞风华',
    		re_huangyueying: '#y深藏不露',
    		re_sunquan: '#y东吴大帝',
    		re_sunshangxiang: '#y不让须眉',
    		re_zhenji: '#y轻云蔽月',
    		re_zhugeliang: '#y鞠躬尽瘁',
    		re_huaxiong: '#y暴走汜水',
    		re_gongsunzan: '#y白马将军',
    		caoren: '#y大将军',
    		ol_xiahouyuan: '#y疾行的猎豹',
    		ol_weiyan: '#y汉中镇守',
    		ol_xiaoqiao: '#y仙姿玉质',
    		zhoutai: '#y历战之躯',
    		re_zhangjiao: '#y太平教主',
    		xin_yuji: '#y缠怨索魂',
    		ol_huangzhong: '#y老将的逆袭',
    		ol_sp_zhugeliang: '#y隆中对',
    		ol_xunyu: '#y万岁亭侯',
    		ol_dianwei: '#y临危横贯',
    		ol_yanwen: '#y二夫之勇',
    		ol_pangtong: '#y凤雏高翔',
    		...
    		re_fazheng: '#y蜀汉的辅翼',
    		xin_lingtong: '#y豪情烈胆',
    		re_zhangchunhua: '#y冷血皇后',
    		dc_xushu: '#y化剑为犂',
    		re_chengong: '#y刚直壮烈',
    		re_madai: '#y临危受命',
    		re_wangyi: '#y决意的巾帼',
    		xin_handang: '#y石城侯',
    		xin_zhonghui: '#y桀骜的野心家',
    		re_liaohua: '#y历尽沧桑',
    		re_chengpu: '#y三朝虎臣',
    		re_caozhang: '#y黄须儿',
    		dc_bulianshi: '#y无冕之后',
    		...
    		re_caoxiu: '#y征东大将军',
    		re_sunxiu: '#y弥殇的景君',
    		re_gongsunyuan: '#y狡黠的投机者',
    		re_guotufengji: '#y凶蛇两端',
    		re_xiahoushi: '#y疾冲之恋',
    		re_liuchen: '#y血荐轩辕',
    		re_zhuzhi: '#y王事靡盬',
    		re_caorui: '#y天姿的明君',
    		re_guohuanghou: '#y月华驱霾',
    		re_sundeng: '#y才高德茂',
    		xin_zhangliang: '#y人公将军',
    		re_zhugedan: '#y薤露蒿里',
    		re_simalang: '#y再世神农',
    		re_duji: '#y卧镇京畿',
    		dc_gongsunzan: '#y白马将军',
    		re_sp_taishici: '#y北海酬恩',
    		re_caiyong: '#y大鸿儒',
    		re_mazhong: '#y笑合南中',
    		re_wenpin: '#y坚城宿卫',
    		re_jsp_huangyueying: '#y闺中璞玉',
		},
		characterFilter:{
		...
		skill:{
			...
			rewansha:{
				audio:'wansha',
				audioname:['re_jiaxu','shen_simayi','new_shen_simayi','boss_lvbu2','xin_shen_simayi'],
			...
			rezhiheng:{
				audio:2,
				audioname:['shen_caopi','xin_shen_simayi'],
				enable:'phaseUse',
				usable:1,
				position:'he',
			...
			rejizhi:{
				audio:2,
				audioname:['lukang','xin_shen_simayi'],
				locked:false,
				trigger:{player:'useCard'},
				frequent:true,
				filter:function(event){
			...
			reguicai:{
				audio:2,
				audioname:['new_shen_simayi','xin_shen_simayi'],
				trigger:{global:'judge'},
				direct:true,
				filter:function(event,player){
		...
		translate:{
			...
			rejianyan:'荐言',
			rejianyan_info:'出牌阶段每项各限一次。你可选择一种颜色或一种牌的类别，然后系统从牌堆中检索出一张满足该条件的牌并展示之。然后你将此牌交给一名男性角色。',
			re_zhanghe:'界张郃',
			reqiaobian:'巧变',
