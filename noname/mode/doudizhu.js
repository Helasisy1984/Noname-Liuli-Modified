		...
		start:function(){
			...
			switch(_status.mode){
				...
				default:
					...
					var enhance = _status.connectMode ? lib.configOL.enhance_dizhu : get.config("enhance_dizhu");
					var list = [];
					if (enhance === "kaihei") {
						list.push("kaihei");
		...
		game:{
			...
			chooseCharacterZhidou:function(){
				...
				next.setContent(function(){
					...
					lib.config.mode_config['doudizhu'].double_character = game.me==game.zhu;
					...
					"step 5"
					lib.config.mode_config['doudizhu'].double_character = false;
			...
			chooseCharacter:function(){
				...
				next.setContent(function(){
					...
					if(event.chosen.length){
						if(lib.character[event.chosen[0]][1]=='shen'||lib.character[event.chosen[0]][1]=='devil'){
							if(get.config('choose_group')) chooseGroup=true;
						}
					}
						...
						if(lib.character[event.choosed[0]][1]=='shen'||lib.character[event.choosed[0]][1]=='devil'){
							if(get.config('choose_group')) chooseGroup=true;
						}
					}
					else{
